    class kif_BrickStack: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\Bricks.paa";
	...
	class kif_MetalStack: ItemCore
	{
		...
		descriptionShort="Hand these in at a Building Vendor!";
		picture="\sl_client\textures\icons\items\Metal.paa";
	...
	class kif_Grinder: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\Grinder.paa";
	...
	class kif_Pseudo: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\container.paa";
	...
	class kif_GasCooker: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\GasCooker.paa";
	...
	class kif_Acetone: ItemCore
	{
		...
		displayName="Acetone";
		descriptionShort="I hope you know what to do with this!";
		picture="\sl_client\textures\icons\items\Acetone.paa";
	...
	class kif_100k: ItemCore
	{
		...
		displayName="100 000$";
		descriptionShort="I hope you know what to do with this!";
		picture="\sl_client\textures\icons\items\suitcase.paa";
	...
	class kif_25k: ItemCore
	{
		...
		descriptionShort="I hope you know what to do with this!";
		picture="\sl_client\textures\icons\items\suitcase.paa";
		model="\sl_client\models\suitcase\suitcase_closed.p3d";
		allowedSlots[]={901,801,701};
		mass=50;
	};
	...
	class kif_gopro: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\gopro.paa";
		model="\sl_client\models\gopro\gopro.p3d";
		allowedSlots[]={901,801,701};
		mass=15;
	};
	class kif_nitro: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\nitro.paa";
		model="\sl_client\models\nos\nitro.p3d";
		allowedSlots[]={901};
		mass=15;
	};
	class kif_panicbutton: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\panicbutton.paa";
		model="\sl_client\models\panicbutton\button.p3d";
		allowedSlots[]={901,801,701};
		mass=15;
	};
	class kif_speedbomb: ItemCore
	{
		...
		picture="\sl_client\textures\icons\items\dynamite.paa";
		model="\sl_client\models\dynamit\dynamit.p3d";
		allowedSlots[]={901};
		mass=15;
	};
	class kif_fish_oil: ItemCore
	{
		...
		displayName="Tran";
		author="Extermi111";
		picture="\sl_client\textures\icons\items\fish_oil.paa";
		model="\sl_client\models\fish_oil\fish_oil.p3d";
		allowedSlots[]={901};
		mass=15;
	};
	class kif_gold_bar: ItemCore
	{
		...
		//picture="\sl_client\textures\icons\items\fish_oil.paa";
		model="\sl_client\models\ore_bar\gold_bar.p3d";
		allowedSlots[]={901};
		mass=15;
	};