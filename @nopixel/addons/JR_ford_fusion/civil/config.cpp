...
{
	class JR_vehiculos_civiles
	{
		displayName="[JR LIFE RPG] Vehiculos Civiles";
	};
};
class CfgPatches
{
	class JR_ford_fusion_civil
	{
		units[]=
		{
			"JR_ford_fusion_civil"
		};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
...
class CfgVehicles
{
	...
	class JR_ford_fusion_civil_base: Car_F
	{
		vehicleClass="west_vehiculos_civiles";
		model="JR_ford_fusion\civil\JR_ford_fusion.p3d";
	...
	class JR_ford_fusion_civil_black: JR_ford_fusion_civil_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		...
		hiddenSelectionsTextures[]=
		{
			"JR_ford_fusion\data\rvmat\negro.paa"
		};
		displayName="Ford Fusion Black";
	};
	class JR_ford_fusion_civil_white: JR_ford_fusion_civil_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		...
		hiddenSelectionsTextures[]=
		{
			"JR_ford_fusion\data\rvmat\Blanco.paa"
		};
		displayName="Ford Fusion White";
	};
	class JR_ford_fusion_civil_blue: JR_ford_fusion_civil_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		...
		hiddenSelectionsTextures[]=
		{
			"JR_ford_fusion\data\rvmat\Azul_Oscuro.paa"
		};
		displayName="Ford Fusion Blue";
	};
	class JR_ford_fusion_civil_red: JR_ford_fusion_civil_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		...
		hiddenSelectionsTextures[]=
		{
			"JR_ford_fusion\data\rvmat\Rojo_Oscuro.paa"
		};
		displayName="Ford Fusion Red";
	};
	class JR_ford_fusion_civil_yellow: JR_ford_fusion_civil_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		...
		hiddenSelectionsTextures[]=
		{
			"JR_ford_fusion\data\rvmat\amarillo.paa"
		};
		displayName="Ford Fusion Yellow";
	};
};
class cfgMods
{
