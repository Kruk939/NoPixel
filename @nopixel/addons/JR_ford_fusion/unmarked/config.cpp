...
class CfgPatches
{
	class JR_ford_fusion_unmarked
	{
		units[]=
		{
			"JR_ford_fusion_unmarked"
		};
		weapons[]={};
		requiredVersion=0.1;
		requiredAddons[]=
...
class CfgVehicles
{
	...
	class JR_ford_fusion_unmarked_base: Car_F
	{
        #include "\sl_vehicles_red\data\sirenArray.hpp"
		vehicleClass="JR_police_vehicles";
		model="JR_ford_fusion\unmarked\JR_ford_fusion_unmarked.p3d";
	...
	class JR_ford_fusion_unmarked_1: JR_ford_fusion_unmarked_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="Ford Fusion Unmarked Black";
		vehicleClass="JR_police_vehicles";
		author="Jose Ramos";
		hiddenSelectionsTextures[]=
		{
	...
	class JR_ford_fusion_unmarked_2: JR_ford_fusion_unmarked_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="Ford Fusion Unmarked White";
		vehicleClass="JR_police_vehicles";
		author="Jose Ramos";
		hiddenSelectionsTextures[]=
		{
	...
	class JR_ford_fusion_unmarked_3: JR_ford_fusion_unmarked_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="Ford Fusion Unmarked Red";
		vehicleClass="JR_police_vehicles";
		author="Jose Ramos";
		hiddenSelectionsTextures[]=
		{
	...
	class JR_ford_fusion_unmarked_4: JR_ford_fusion_unmarked_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="Ford Fusion Unmarked Blue";
		vehicleClass="JR_police_vehicles";
		author="Jose Ramos";
		hiddenSelectionsTextures[]=
		{
	...
	class JR_ford_fusion_unmarked_5: JR_ford_fusion_unmarked_base
	{
		scope=2;
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		displayName="Ford Fusion Unmarked Yellow";
		vehicleClass="JR_police_vehicles";
		author="Jose Ramos";
		hiddenSelectionsTextures[]=
		{
