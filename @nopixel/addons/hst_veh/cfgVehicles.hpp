...
class HST_CVPI_MD014 : HST_CVPI_base
{
...
class Tahoe_01;
class Tahoe_DOJ : Tahoe_01
{
	maxSpeed = 250;
	peakTorque = 700;
	fuelCapacity = 20;
	displayName = "Chevrolet Tahoe Department of Justice";
	hiddenSelectionsTextures[] = {"\hst_veh\textures\DOJ_101.paa","","","","","","","","","","","","","","","","","","","","","","",""};
};
