...
class CfgVehicles
{
	...
	{
		model 	= "\red_cvpi_06\red_cvpi_06_p";  /// simple path to model
	...
	/*----------------------------------*/
		...
		thrustDelay = 0.1;
		brakeIdleSpeed = 1.78;
		maxSpeed = 206;	// max speed on level road, km/h
		fuelCapacity = 45;
	...
	{	
		...
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\black.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\aqua.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\darkblue.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\blue.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\green.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\red.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\pink.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\yellow.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\orange.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\white.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\purple.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\darkgreen.paa"};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_cvpi_06\colours\darkred.paa"};
	};
	
		class red_cvpi_06_custom:red_cvpi_06_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2006 Ford Crown Victoria (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_cvpi_06\skins\custom1.paa"};
	};
	
		class red_cvpi_06_custom2:red_cvpi_06_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2006 Ford Crown Victoria (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_cvpi_06\skins\custom2.paa"};
	};
	
		class red_cvpi_06_custom3:red_cvpi_06_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2006 Ford Crown Victoria (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_cvpi_06\skins\custom3.paa"};
	};
};