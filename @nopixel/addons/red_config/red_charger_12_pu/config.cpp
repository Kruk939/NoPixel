...
class cfgVehicles
{
	...
	class red_charger_12_p_u_statetrooper: red_charger_12_p_u_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_charger_12_pu\skins\StateTrooper.paa"};
	};
	...
	class red_charger_12_p_u_custom1: red_charger_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (Slicktop)(Custom 1)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_charger_12_pu\skins\custom1.paa"};
	};
	class red_charger_12_p_u_custom2: red_charger_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (Slicktop)(Custom 2)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_charger_12_pu\skins\custom2.paa"};
	};
	class red_charger_12_p_u_custom3: red_charger_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (Slicktop)(Custom 3)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_charger_12_pu\skins\custom3.paa"};
	};
	
	class red_charger_12_p_u_custom4: red_charger_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (Slicktop)(Custom 4)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_charger_12_pu\skins\custom4.paa"};
	};
	
	class red_charger_12_p_u_custom5: red_charger_12_p_u_base
	{
		scope = 2;
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_charger_12_pu\skins\custom5.paa"};
	};
};