...
class cfgVehicles
{
	...
	class red_camaro_12_p_u_base: Car_F
	{
		...
		soundDammage[]={"", db-5, 1};
		soundEngineOnInt[] = {"red_base\sounds\MUSCLE_V8\v8_int_start",0.39810717,1.0};
		soundEngineOnExt[] = {"red_base\sounds\MUSCLE_V8\v8_ext_start",2.566836,1.0,200};
		soundEngineOffInt[] = {"red_base\sounds\MUSCLE_V8\v8_int_stop",0.39810717,1.0};
		soundEngineOffExt[] = {"red_base\sounds\MUSCLE_V8\v8_ext_stop",0.4466836,1.0,200};	
		...
		class Sounds
		{
			...
			class	Idle_ext
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_ext_idle", db-7.4,	1, 150};
				frequency	=	0.9	+	HZ_IDLE*0.2;
				volume = engineOn*camPos*VOLUME_IDLE;
			};
			class	Engine
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_ext_1000",	db-11,1, 200};
				frequency	=	0.8	+	HZ_RPM1*0.2;
				volume = engineOn*camPos*VOLUME_RPM1;
			};
			class	Engine1_ext
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_ext_2000",	db-9,1, 240};
				frequency	=	0.8	+	HZ_RPM2*0.2;
				volume = engineOn*camPos*VOLUME_RPM2;
			};
			class	Engine2_ext
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_ext_3000",	db-8,1, 280};
				frequency	=	0.8	+	HZ_RPM3*0.2;
				volume = engineOn*camPos*VOLUME_RPM3;
			};
			class	Engine3_ext
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_ext_4000",	db-7,1, 320};
				frequency	=	0.8	+	HZ_RPM4*0.2;
				volume = engineOn*camPos*VOLUME_RPM4;
			};
			class	Engine4_ext
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_ext_5000",	db-6,1, 360};
				frequency	=	0.8	+	HZ_RPM5*0.2;
				volume = engineOn*camPos*VOLUME_RPM5;
			};
			class	Engine5_ext
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_ext_6000",	db-5,1, 420};
			...
			class	Idle_int
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_int_idle", db-15,	1};
				frequency	=	0.9	+	HZ_IDLE*0.2;
				volume = engineOn*(1-camPos)*VOLUME_IDLE;
			};
			class	Engine_int
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_int_1000",	db-14,1 };
				frequency	=	0.8	+	HZ_RPM1*0.2;
				volume = engineOn*(1-camPos)*VOLUME_RPM1;
			};
			class	Engine1_int
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_int_2000",	db-12,1 };
				frequency	=	0.8	+	HZ_RPM2*0.2;
				volume = engineOn*(1-camPos)*VOLUME_RPM2;
			};
			class	Engine2_int
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_int_3000",	db-11,1 };
				frequency	=	0.8	+	HZ_RPM3*0.2;
				volume = engineOn*(1-camPos)*VOLUME_RPM3;
			};
			class	Engine3_int
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_int_4000",	db-10,1 };
				frequency	=	0.8	+	HZ_RPM4*0.2;
				volume = engineOn*(1-camPos)*VOLUME_RPM4;
			};
			class	Engine4_int
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_int_5000",	db-9,1 };
				frequency	=	0.8	+	HZ_RPM5*0.2;
				volume = engineOn*(1-camPos)*VOLUME_RPM5;
			};
			class	Engine5_int
			{
				sound[]	=	{"red_base\sounds\MUSCLE_V8\v8_int_6000",	db-6,1 };
				frequency	=	0.95	+	HZ_RPM6*0.15;
	...
	{	
		...
		displayName = "2012 Chevrolet Camaro ZL1 (Black)(Unmarked)";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Aqua)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Dark Blue)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Green)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Red)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Pink)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Yellow)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Orange)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (White)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Purple)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Dark Green)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Dark Red)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{	
		...
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Chevrolet Camaro ZL1 (Blue)(Unmarked)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
	...
	{
		scope = 2;
		displayName = "2012 Chevrolet Camaro ZL1 (Custom 1)(Unmarked)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_camaro_12_pu\skins\custom1.paa"};
	};
	
	class red_camaro_12_p_u_custom2: red_camaro_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Chevrolet Camaro ZL1 (Custom 2)(Unmarked)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_camaro_12_pu\skins\custom2.paa"};
	};
	
	class red_camaro_12_p_u_custom3: red_camaro_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Chevrolet Camaro ZL1 (Custom 3)(Unmarked)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_camaro_12_pu\skins\custom3.paa"};
	};
	
	class red_camaro_12_p_u_custom4: red_camaro_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Chevrolet Camaro ZL1 (Custom 4)(Unmarked)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_camaro_12_pu\skins\custom4.paa"};
	};
	
	class red_camaro_12_p_u_custom5: red_camaro_12_p_u_base
	{
		scope = 2;
		displayName = "2012 Chevrolet Camaro ZL1 (Custom 5)(Unmarked)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_camaro_12_pu\skins\custom5.paa"};
	};
};