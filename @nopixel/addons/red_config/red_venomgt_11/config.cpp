...
class CfgVehicles
{
	...
	{
		model 	= "\red_venomgt_11\red_venomgt_11_p";  /// simple path to model
		...
		thrustDelay = 0.1;
		brakeIdleSpeed = 1.78;
		maxSpeed = 434;	// max speed on level road, km/h
		fuelCapacity = 45;
		...
		class Wheels
		{
			class LF
			{
				...
				mMaxDroop = 0.20;
				sprungMass = 273; 
				springStrength = 8813; //6813
				springDamperRate = 1911; //1091
	...
	{	
		...
		class red_venomgt_11_custom:red_venomgt_11_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2011 Hennessey Venom GT (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_venomgt_11\skins\custom1.paa","","","","","","",""};
	};
	
		
		class red_venomgt_11_custom2:red_venomgt_11_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2011 Hennessey Venom GT (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_venomgt_11\skins\custom2.paa","","","","","","",""};
	};
	
		class red_venomgt_11_custom3:red_venomgt_11_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2011 Hennessey Venom GT (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_venomgt_11\skins\custom3.paa","","","","","","",""};
	};
};