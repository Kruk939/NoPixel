...
class cfgVehicles
{
	...
	class red_charger_15_p_u_sheriff: red_charger_15_p_u_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_15_pu\skins\sheriff.paa"};
	};
	...
	class red_charger_15_p_u_sert: red_charger_15_p_u_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_15_pu\skins\sert.paa"};
	};
	class red_charger_15_p_u_statetrooper: red_charger_15_p_u_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_15_pu\skins\StateTrooper.paa"};
	};
	...
	class red_charger_15_p_u_custom1: red_charger_15_p_u_base
	{
		scope = 2;
		displayName = "2015 Dodge Charger R/T (Custom 1)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_15_pu\skins\custom1.paa"};
	};
	
	class red_charger_15_p_u_custom2: red_charger_15_p_u_base
	{
		scope = 2;
		displayName = "2015 Dodge Charger R/T (Custom 2)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_15_pu\skins\custom2.paa"};
	};
	
	class red_charger_15_p_u_custom3: red_charger_15_p_u_base
	{
		scope = 2;
		displayName = "2015 Dodge Charger R/T (Custom 3)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_15_pu\skins\custom3.paa"};
	};
	
	class red_charger_15_p_u_custom4: red_charger_15_p_u_base
	{
		scope = 2;
		displayName = "2015 Dodge Charger R/T (Custom 4)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_15_pu\skins\custom4.paa"};
	};
	
	class red_charger_15_p_u_custom5: red_charger_15_p_u_base
	{
		scope = 2;
		displayName = "2015 Dodge Charger R/T (Custom 5)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
