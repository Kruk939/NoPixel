...
class cfgVehicles
{
	...
	class red_charger_15_p_unmarked: red_charger_15_p_u_base
	{
		scope=2;
		displayName="2015 Dodge Charger R/T (Slicktop)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		weapons[] = {"Airhorn1","Airhorn2","Howler","Manual","Takedown","pull"};
	...
	class red_charger_15_p_unmarked_ems: red_charger_15_p_u_base
	{
		scope=2;
		displayName="2015 Dodge Charger R/T (Slicktop EMS)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
