...
class cfgVehicles
{
	...
	class red_explorer_16_p_p_base: Car_F
	{
		model = "\red_explorer_16_p\red_explorer_16_p_p";
		...
		class eventhandlers
		{
			init = "_this execVM ""red_explorer_16_p\scripts\init.sqf"";";
		};
		class UserActions
		{
			class codeone
	...
	class red_explorer_16_p_custom1: red_explorer_16_p_p_base
	{
		scope = 2;
		displayName = "2016 Ford Explorer (P)(Custom 1)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_explorer_16_p\skins\custom1.paa"};
	};
	class red_explorer_16_p_custom2: red_explorer_16_p_p_base
	{
		scope = 2;
		displayName = "2016 Ford Explorer (P)(Custom 2)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_explorer_16_p\skins\custom2.paa"};
	};
	class red_explorer_16_p_custom3: red_explorer_16_p_p_base
	{
		scope = 2;
		displayName = "2016 Ford Explorer (P)(Custom 3)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_explorer_16_p\skins\custom3.paa"};
	};
	
	class red_explorer_16_p_custom4: red_explorer_16_p_p_base
	{
		scope = 2;
		displayName = "2016 Ford Explorer (P)(Custom 4)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_explorer_16_p\skins\custom4.paa"};
	};
	
	class red_explorer_16_p_custom5: red_explorer_16_p_p_base
	{
		scope = 2;
		displayName = "2016 Ford Explorer (P)(Custom 5)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_explorer_16_p\skins\custom5.paa"};
	};
	
	class red_explorer_16_p_black: red_explorer_16_p_p_base
	{
		scope = 2;
		displayName = "2016 Ford Explorer (Unmarked Black)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_base\colours\black.paa"};
	};
	class red_explorer_16_p_white: red_explorer_16_p_p_base
	{
		scope = 2;
		displayName = "2016 Ford Explorer (Unmarked White)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
