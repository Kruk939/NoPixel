...
class CfgVehicles
{
	...
	{
		model 	= "\red_porsche_12\red_porsche_12_p";  /// simple path to model
		...
		thrustDelay = 0.1;
		brakeIdleSpeed = 1.78;
		maxSpeed = 331;	// max speed on level road, km/h
		fuelCapacity = 45;
	...
	{	
		...
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\black.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\aqua.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\blue.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\darkblue.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\green.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\red.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\pink.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\yellow.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\orange.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\white.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\purple.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\darkgreen.paa","","","","","","",""};
	};
	...
	{	
		...
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_porsche_12\colours\darkred.paa","","","","","","",""};
	};
	
		class red_porsche_12_custom:red_porsche_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Porsche GT2 RS (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_porsche_12\skins\custom1.paa","","","","","","",""};
	};
	
		class red_porsche_12_custom2:red_porsche_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Porsche GT2 RS (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_porsche_12\skins\custom2.paa","","","","","","",""};
	};
	
		
		class red_porsche_12_custom3:red_porsche_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Porsche GT2 RS (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_porsche_12\skins\custom3.paa","","","","","","",""};
	};
};