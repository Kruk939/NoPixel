...
class CfgVehicles
{
	...
	{
		model 	= "\red_xkrs_12\red_xkrs_12_p";  /// simple path to model
		...
		soundDammage[]={"", db-5, 1};
		soundEngineOnInt[] = {"red_base\sounds\SPORTS_V8\int-start.wss", db-8, 1.0};
		soundEngineOnExt[] = {"red_base\sounds\SPORTS_V8\ext-start.wss", db-7, 1.0, 200};
		soundEngineOffInt[] = {"red_base\sounds\SPORTS_V8\int_stop.wss", db-8, 1.0};
		soundEngineOffExt[] = {"red_base\sounds\SPORTS_V8\ext_stop.wss", db-7, 1.0, 200};
		...
		thrustDelay = 0.1;
		brakeIdleSpeed = 1.78;
		maxSpeed = 299;	// max speed on level road, km/h
		fuelCapacity = 45;
	...
	{	
		...
		class red_xkrs_12_custom:red_xkrs_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Jaguar XKR-S (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_xkrs_12\skins\custom1.paa","","","","","","",""};
	};
	
		class red_xkrs_12_custom2:red_xkrs_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Jaguar XKR-S (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_xkrs_12\skins\custom2.paa","","","","","","",""};
	};
	
		class red_xkrs_12_custom3:red_xkrs_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Jaguar XKR-S (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_xkrs_12\skins\custom3.paa","","","","","","",""};
	};
};