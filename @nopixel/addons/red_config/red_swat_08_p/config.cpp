...
class cfgVehicles
{
	...
	class red_swat_08_p_p_base: Car_F
	{
		model = "\red_swat_08_p\red_swat_08_p_p";
		...
		hiddenSelectionsTextures[] = {"red_base\colours\black.paa","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","red_base\colours\white.paa"};
		terrainCoef = 1.0;
		turnCoef = 2.5;
		precision = 10;
		fireResistance = 5;
		...
		transportSoldier = 15;
		extCameraPosition[] = {0, 1, -10.5.0};
		
		class AnimationSources
		{
            class radiotower_1_rot
            {
                source = user;
                initPhase = 0;
                animPeriod = 4;
		...
		class eventhandlers
		{
			init = "_this execVM ""red_swat_08_p\scripts\init.sqf"";";
		};
		...
		class UserActions
		{
			...
			class TowerLightOn
			{
				displayName =  "Towerlight On";
				position = "drivewheel";
				radius = 10;
				onlyForPlayer = 0;
				condition = "driver this == player && (this getVariable ['Light_T',0]) == 0 && ((this animationPhase 'radiotower_1_rot') > 0.5)";
				statement = "this setVariable ['Light_T',1,true]";
			};
			
			class TowerLightOff
			{
				displayName =  "Towerlight Off";
				position = "drivewheel";
				radius = 10;
				onlyForPlayer = 0;
				condition = "driver this == player && (this getVariable ['Light_T',0]) == 1";
				statement = "this setVariable ['Light_T',0,true]";
			};
			
			class Raisetower_1
            {
                displayName = "Raise Tower";
                position = "drivewheel"; 
				radius = 10;
				onlyForplayer = "true";
                condition = "driver this == player && ((this animationPhase 'radiotower_1_rot') < 0.5)";
                statement = "this animate [""radiotower_1_rot"",1];";
            };
			
			class Lowertower_1
            {
                displayName = "Lower Tower";
                position = "drivewheel"; 
				radius = 10;
				onlyForplayer = "true";
				condition = "driver this == player && (this getVariable ['Light_T',0]) == 0 && (this animationPhase ('radiotower_1_rot') > 0.5)";
                statement = "this animate [""radiotower_1_rot"",0];";
            };
		};
		...
		cargoAction[] = {passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_low01,passenger_generic01_leanleft,passenger_generic01_leanright};
		...
		class Reflectors
		{
			...
			{
				color[] 		= {2000, 2000, 1800};		/// approximate colour of standard lights
			...
			class LightCarHeadT01 	/// lights on each side consist of two bulbs with different flares
			{
				color[] 		= {1900, 1800, 2000};		/// approximate colour of standard 
				ambient[]		= {5, 5, 5};				/// nearly a white one
				position 		= "LightCarHeadT01";		/// memory point for start of the light and flare
				direction 		= "LightCarHeadT01_end";	/// memory point for the light direction
				hitpoint 		= "Light_T1";				/// point(s) in hitpoint lod for the light (hitPoints are created by engine)
				selection 		= "Light_T1";				/// selection for artificial glow around the bulb, not much used any more
				size 			= 1;						/// size of the light point seen from distance
				innerAngle 		= 75;						/// angle of full light
				outerAngle 		= 110;						/// angle of some light
				coneFadeCoef 	= 10;						/// attenuation of light between the above angles
			...
			class LightCarHeadT02: LightCarHeadT01
				{
				position 	= "LightCarHeadT02";
				direction 	= "LightCarHeadT02_end";
				hitpoint 	= "Light_T2";
				selection 	= "Light_T2";
				};
				
				class LightCarHeadT03: LightCarHeadT01
				{
				position 	= "LightCarHeadT03";
				direction 	= "LightCarHeadT03_end";
				hitpoint 	= "Light_T3";
				selection 	= "Light_T3";
				};
		};
		aggregateReflectors[] = {"LightCarHeadL01","LightCarHeadR01","LightCarHeadT01","LightCarHeadT02","LightCarHeadT03"};
	};

	class red_swat_08_p_swat: red_swat_08_p_p_base
	{
		scope = 2;
		displayName = "2008 Ford F-350 SUPERDUTY Command Centre (SWAT)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_swat_08_p\skins\default.paa","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","red_config\red_swat_08_p\skins\default2.paa"};
	};
};
