...
class cfgVehicles
{
	...
	class red_charger_12_p_statetrooper: red_charger_12_p_p_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_12_p\skins\StateTrooper.paa"};
	};
	
	class red_charger_12_p_custom1: red_charger_12_p_p_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (P)(Custom 1)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_12_p\skins\custom1.paa"};
	};
	class red_charger_12_p_custom2: red_charger_12_p_p_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (P)(Custom 2)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_12_p\skins\custom2.paa"};
	};
	class red_charger_12_p_custom3: red_charger_12_p_p_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (P)(Custom 3)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_12_p\skins\custom3.paa"};
	};
	
	class red_charger_12_p_custom4: red_charger_12_p_p_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (P)(Custom 4)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_12_p\skins\custom4.paa"};
	};
	
	class red_charger_12_p_custom5: red_charger_12_p_p_base
	{
		scope = 2;
		displayName = "2012 Dodge Charger SRT8 (P)(Custom 5)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_config\red_charger_12_p\skins\custom5.paa"};
	};
	...
	class sl_charger_sert: red_charger_12_p_p_base
	{
		scope=2;
		...
		{
			"red_config\red_charger_12_p\skins\sert02.paa"
		};
	};
