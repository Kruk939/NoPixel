...
class CfgVehicles
{
	...
	{
		model 	= "\red_s65_12\red_s65_12_p";  /// simple path to model
		...
		antiRollbarForceCoef = 0.20;
		antiRollbarForceLimit = 0.20;
	...
	{	
		...
		class red_s65_12_custom:red_s65_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Mercedes-Benz S65 AMG (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_s65_12\skins\custom1.paa","","","","","","",""};
	};
	
		class red_s65_12_custom2:red_s65_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Mercedes-Benz S65 AMG (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_s65_12\skins\custom2.paa","","","","","","",""};
	};
	
		class red_s65_12_custom3:red_s65_12_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2012 Mercedes-Benz S65 AMG (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_s65_12\skins\custom3.paa","","","","","","",""};
	};
};