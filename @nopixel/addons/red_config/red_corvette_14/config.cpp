...
class CfgVehicles
{
	...
	{
		model 	= "\red_corvette_14\red_corvette_14_p";  /// simple path to model
		...
		thrustDelay = 0.1;
		brakeIdleSpeed = 1.78;
		maxSpeed = 281;	// max speed on level road, km/h
		fuelCapacity = 45;
		...
		class Exhausts /// specific exhaust effects for the car
		{
			...
			class Exhaust3 /// the car has two exhausts - each on one side
			{
				position 	= "exhaust3_pos";  		/// name of initial memory point
				direction 	= "exhaust3_dir";	/// name of memory point for exhaust direction
				effect 		= "ExhaustsEffect";	/// what particle effect is it going to use
			};
	...
	{	
		...
		class red_corvette_14_custom:red_corvette_14_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2014 Chevrolet Corvette (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"red_config\red_corvette_14\skins\custom1.paa","","","","","","",""};
	};
	
		class red_corvette_14_custom2:red_corvette_14_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2014 Chevrolet Corvette (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"red_config\red_corvette_14\skins\custom2.paa","","","","","","",""};
	};
	
		class red_corvette_14_custom3:red_corvette_14_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2014 Chevrolet Corvette (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"red_config\red_corvette_14\skins\custom3.paa","","","","","","",""};
	};
};