class CfgPatches
{
	class red_ambulance_08
	{
		units[] = {"red_ambulance_08_p"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgSounds
{
	...
	{
		name = "Siren1";
		sound[] = {"red_sounds\medical\sounds\siren.wav",1,1};
		titles[] = {};
	};
	class Siren2
	{
		name = "Siren2";
		sound[] = {"red_sounds\medical\sounds\yelp.wav",1,1};
		titles[] = {};
	};
};
...
class cfgWeapons
{
	...
	class red_horn_airhorn: SportCarHorn
	{
		displayname = "Airhorn";
		reloadTime = 4;
		drySound[] = {"red_sounds\medical\sounds\FederalAirhorn.wav",1,1};
		scope = 2;
	};
	...
	class red_horn_takedown1: SportCarHorn
	{
		...
		reloadtime = 4;
		drysound[] = {"red_sounds\medical\sounds\Takedown1.wav",1,1};
		scope = 2;
	};
	class red_horn_takedown2: SportCarHorn
	{
		...
		reloadtime = 4;
		drysound[] = {"red_sounds\medical\sounds\Takedown2.wav",1,1};
		scope = 2;
	};
};
...
class cfgVehicles
{
	...
	class red_ambulance_08_p_base: Car_F
	{
		model = "\red_ambulance_08\red_ambulance_08_p";
		picture	= "\red_base\textures\icon.paa"; /// icon in map	
		Icon	= "\red_base\textures\icon.paa"; /// icon in map	
		author = "Redhotsteel";
		weapons[] = {"red_horn_airhorn","red_horn_takedown1","red_horn_takedown2"};
		hiddenSelections[] = {
		"camo1",
		"lb_1_b",
		"lb_2_b",
		...
		hiddenSelectionsTextures[] = {"red_base\colours\red.paa","","","","","","","","","","","","","","","","","","","","","red_base\colours\red.paa"};
		terrainCoef = 1.0;
		turnCoef = 2.5;
		precision = 10;
		fireResistance = 5;
		...
		extCameraPosition[] = {0, 1, -9.0};
		
		class eventhandlers
		{
			init = "_this execVM ""red_ambulance_08\scripts\init.sqf"";";
		};
		class UserActions
		{
			class codeone
			...
			class LoadStretcher
			{
			  displayName = "Load Stretcher";
			  radius = 3;
			  position = "door_trigger";
			  onlyForplayer = 0;
			  condition = "(this animationPhase 'door_1_rot' > 0.5) && (this animationPhase 'door_2_rot' > 0.5)";
			  statement = "[this] execVM '\red_ambulance_08\scripts\loadstretcher.sqf';";
			};
           
			class UnloadStretcher
			{
			  displayName = "Unload Stretcher";
			  radius = 3;
			  position = "door_trigger";
			  onlyForplayer = 0;
			  condition = "(this animationPhase 'door_1_rot' > 0.5) && (this animationPhase 'door_2_rot' > 0.5)";
			  statement = "[this] execVM '\red_ambulance_08\scripts\unloadstretcher.sqf'";
			};
		...
		cargoAction[] = {passenger_apc_generic04,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_apc_narrow_generic01,passenger_low01,passenger_generic01_leanleft,passenger_generic01_leanright};
	...
	class red_ambulance_08_EMS: red_ambulance_08_p_base
	{
		scope = 2;
		displayName = "2008 Ford F350 Ambulance (Default)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"red_base\colours\red.paa","","","","","","","","","","","","","","","","","","","","","red_base\colours\red.paa"};
	};
	class red_ambulance_08_EMSs: red_ambulance_08_p_base
	{
		scope=2;
		displayName="F350 Ambulance (EMS)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		hiddenSelectionsTextures[]=
		{
			"red_config\red_ambulance_08\skins\frontEMS.paa",
			"",
			"",
			"",
			"",
			...
			"",
			"",
			"red_config\red_ambulance_08\skins\backEMS.paa"
		};
	};
	class red_ambulance_08_SR: red_ambulance_08_p_base
	{
		scope=2;
		displayName="F350 Ambulance (SR)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		hiddenSelectionsTextures[]=
		{
			"red_config\red_ambulance_08\skins\frontSR.paa",
			"",
			"",
			"",
			"",
			...
			"",
			"",
			"red_config\red_ambulance_08\skins\backSR.paa"
		};
	};
	class red_ambulance_08_FD: red_ambulance_08_p_base
	{
		scope=2;
		displayName="F350 Ambulance (FD)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		hiddenSelectionsTextures[]=
		{
			"red_config\red_ambulance_08\skins\frontFD.paa",
			"",
			"",
			"",
			"",
			...
			"",
			"",
			"red_config\red_ambulance_08\skins\backFD.paa"
		};
	};
};