...
class CfgSounds
{
	...
	class Siren1
	{
		...
		sound[]=
		{
			"red_ambulance_08\sounds\siren.wav",
			1,
			1
		};
		titles[]={};
	...
	class Siren2
	{
		...
		sound[]=
		{
			"red_ambulance_08\sounds\yelp.wav",
			1,
			1
		};
		titles[]={};
...
class cfgWeapons
{
	...
	class red_horn_airhorn: SportCarHorn
	{
		...
		drySound[]=
		{
			"red_ambulance_08\sounds\FederalAirhorn.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown1: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_ambulance_08\sounds\Takedown1.wav",
			1,
			1
		};
		scope=2;
	...
	class red_horn_takedown2: SportCarHorn
	{
		...
		drysound[]=
		{
			"red_ambulance_08\sounds\Takedown2.wav",
			1,
			1
		};
		scope=2;
	...
	class red_ambulance_08_p_base: Car_F
	{
		...
		class UserActions
		{
			...
			class opendoor_1
			{
				...
				radius=3;
				onlyForplayer="true";
				condition="side player == independent && ((this animationPhase 'door_1_rot') < 0.5)";
			...
			class opendoor_2
			{
				...
				radius=3;
				onlyForplayer="true";
				condition="side player == independent && ((this animationPhase 'door_2_rot') < 0.5)";
			...
			class tow
			{
				...
				displayNameDefault="Load Stretcher";
			...
			class untow
			{
				...
				displayNameDefault="Unload Stretcher";
				position="drivewheel_axis";
				radius=3;
				condition="count attachedObjects this > 0";
