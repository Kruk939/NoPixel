...
class cfgVehicles
{
	...
	class red_taurus_10_p: red_taurus_10_p_p_base
	{
		scope=2;
		displayName="2010 Ford Taurus SHO (Marked)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
		weapons[] = {"Airhorn1","Airhorn2","Howler","Manual","Takedown","pull"};
	...
	class red_taurus_10_p_ems: red_taurus_10_p_p_base
	{
		scope=2;
		displayName="2010 Ford Taurus SHO (EMS)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
