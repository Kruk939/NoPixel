...
class cfgVehicles
{
	...
	class red_taurus_10_p_sheriff: red_taurus_10_p_p_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\sheriff.paa"};
	};
	...
	class red_taurus_10_p_sert: red_taurus_10_p_p_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\sert.paa"};
	};
	class red_taurus_10_p_trooper: red_taurus_10_p_p_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\StateTrooper.paa"};
	};
	
	class red_taurus_10_p_custom1: red_taurus_10_p_p_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (P)(Custom 1)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\custom1.paa"};
	};
	
	class red_taurus_10_p_custom2: red_taurus_10_p_p_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (P)(Custom 2)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\custom2.paa"};
	};
	
	class red_taurus_10_p_custom3: red_taurus_10_p_p_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (P)(Custom 3)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\custom3.paa"};
	};
	
		
	class red_taurus_10_p_custom4: red_taurus_10_p_p_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (P)(Custom 4)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\custom4.paa"};
	};
	
	class red_taurus_10_p_custom5: red_taurus_10_p_p_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (P)(Custom 5)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_p\skins\custom5.paa"};
	};
	class sl_taurus_232: red_taurus_10_p_p_base
	{
		...
		{"red_config\red_taurus_10_p\skins\232.paa"};
		maxSpeed=330;
		enginePower=900;
		peakTorque=1600;
        ...
        class sl_taurus_233: sl_taurus_232
	{
		...
		hiddenSelectionsTextures[]=
		{"red_config\red_taurus_10_p\skins\233.paa"};
		weapons[]=
		{
                        "Airhorn1",
                        "Airhorn2",
