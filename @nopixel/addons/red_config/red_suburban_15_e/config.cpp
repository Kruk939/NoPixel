...
class cfgVehicles
{
	...
	class red_suburban_15_e_EMS: red_suburban_15_e_e_base
	{
		...
		faction = "CIV_F";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_e\skins\suburbanEMS.paa"};
	};
	
	class red_suburban_15_e_custom1: red_suburban_15_e_e_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (P)(Custom 1)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_e\skins\custom1.paa"};
	};
	
	class red_suburban_15_e_custom2: red_suburban_15_e_e_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (P)(Custom 2)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_e\skins\custom2.paa"};
	};
	
	class red_suburban_15_e_custom3: red_suburban_15_e_e_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (P)(Custom 3)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_e\skins\custom3.paa"};
	};
	
	class red_suburban_15_e_custom4: red_suburban_15_e_e_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (P)(Custom 4)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_e\skins\custom4.paa"};
	};
	
	class red_suburban_15_e_custom5: red_suburban_15_e_e_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (P)(Custom 5)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_e\skins\custom5.paa"};
	};
