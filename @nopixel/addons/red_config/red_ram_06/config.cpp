...
class CfgVehicles
{
	...
	{
		model 	= "\red_ram_06\red_ram_06_p";  /// simple path to model
		...
		thrustDelay = 0.1;
		brakeIdleSpeed = 1.78;
		maxSpeed = 248;	// max speed on level road, km/h
		fuelCapacity = 45;
		...
		class Reflectors	/// only front lights are considered to be reflectors to save CPU
		{
			class LightCarHeadL01 	/// lights on each side consist of two bulbs with different flares
			{
				...
				flareSize 		= 0.65;							/// how big is the flare
		...
		class red_ram_06_darkred:red_ram_06_base
	{
		...
		class red_ram_06_custom:red_ram_06_base
	{
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2006 Dodge RAM SRT10 (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_ram_06\skins\custom1.paa","","","","","","",""};
	};
	
		class red_ram_06_custom2:red_ram_06_base
	{
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2006 Dodge RAM SRT10 (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_ram_06\skins\custom2.paa","","","","","","",""};
	};
	
		class red_ram_06_custom3:red_ram_06_base
	{
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2006 Dodge RAM SRT10 (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_ram_06\skins\custom3.paa","","","","","","",""};
	};
};
