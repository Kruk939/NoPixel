...
class cfgVehicles
{
	...
	class red_suburban_15_p_trooper: red_suburban_15_p_p_base
	{
		...
		faction = "CIV_F";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_p\skins\suburbantrooper.paa"};
	};
	...
	class red_suburban_15_p_sheriff: red_suburban_15_p_p_base
	{
		...
		faction = "CIV_F";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_p\skins\sheriff.paa"};
	};
	
	class red_suburban_15_p_custom1: red_suburban_15_p_p_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (Custom 1)(Police)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_p\skins\custom1.paa"};
	};
	
	class red_suburban_15_p_custom2: red_suburban_15_p_p_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (Custom 2)(Police)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_p\skins\custom2.paa"};
	};
	
	class red_suburban_15_p_custom3: red_suburban_15_p_p_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (Custom 3)(Police)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_p\skins\custom3.paa"};
	};
	
	class red_suburban_15_p_custom4: red_suburban_15_p_p_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (Custom 4)(Police)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_p\skins\custom4.paa"};
	};
	
	class red_suburban_15_p_custom5: red_suburban_15_p_p_base
	{
		scope = 2;
		displayName = "2015 Chevrolet Suburban (Custom 5)(Police)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_suburban_15_p\skins\custom5.paa"};
	};
	class sl_suburban_251: red_suburban_15_p_p_base
	{
		scope=2;
		...
		{"red_config\red_suburban_15_p\skins\251.paa"};
		thrustDelay=0.0;
		maxSpeed=350;
		enginePower=1000;
		peakTorque=2000;
