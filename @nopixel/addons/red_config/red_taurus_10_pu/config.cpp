...
class cfgVehicles
{
	...
	class red_taurus_10_p_u_sheriff: red_taurus_10_p_u_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\sheriff.paa"};
	};
	...
	class red_taurus_10_p_u_sert: red_taurus_10_p_u_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\sert.paa"};
	};
	class red_taurus_10_p_u_trooper: red_taurus_10_p_u_base
	{
		...
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\StateTrooper.paa"};
	};
	...
	class red_taurus_10_p_u_custom1: red_taurus_10_p_u_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (Custom 1)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\custom1.paa"};
	};
	
	class red_taurus_10_p_u_custom2: red_taurus_10_p_u_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (Custom 2)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\custom2.paa"};
	};
	
	class red_taurus_10_p_u_custom3: red_taurus_10_p_u_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (Custom 3)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\custom3.paa"};
	};
	
		
	class red_taurus_10_p_u_custom4: red_taurus_10_p_u_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (Custom 4)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\custom4.paa"};
	};
	
	class red_taurus_10_p_u_custom5: red_taurus_10_p_u_base
	{
		scope = 2;
		displayName = "2010 Ford Taurus SHO (Custom 5)(Slicktop)";
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		hiddenSelectionsTextures[] = {"\red_config\red_taurus_10_pu\skins\custom5.paa"};
	};
	class sl_taurus_231: red_taurus_10_p_u_base
	{
		...
		{"red_config\red_taurus_10_pu\skins\231.paa"};
		thrustDelay=0.0;
		maxSpeed=370;
		enginePower=1000;
		peakTorque=2000;
