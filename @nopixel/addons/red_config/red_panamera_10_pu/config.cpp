...
class cfgVehicles
{
	...
	class red_panamera_10_p_u_custom1: red_panamera_10_p_u_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_panamera_10_pu\skins\custom1.paa"
		};
	};
	class red_panamera_10_p_u_custom2: red_panamera_10_p_u_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_panamera_10_pu\skins\custom2.paa"
		};
	};
	class red_panamera_10_p_u_custom3: red_panamera_10_p_u_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_panamera_10_pu\skins\custom3.paa"
		};
	};
	class red_panamera_10_p_u_custom4: red_panamera_10_p_u_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_panamera_10_pu\skins\custom4.paa"
		};
	};
	class red_panamera_10_p_u_custom5: red_panamera_10_p_u_base
	{
		...
		hiddenSelectionsTextures[]=
		{
			"\red_config\red_panamera_10_pu\skins\custom5.paa"
		};
	};
};
class cfgMods
