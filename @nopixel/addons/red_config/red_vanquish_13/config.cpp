...
class CfgVehicles
{
	...
	{
		model 	= "\red_vanquish_13\red_vanquish_13_p";  /// simple path to model
		...
		thrustDelay = 0.1;
		brakeIdleSpeed = 1.78;
		maxSpeed = 323;	// max speed on level road, km/h
		fuelCapacity = 45;
	...
	class red_vanquish_13_custom:red_vanquish_13_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2013 Aston Martin Vanquish (Custom 1)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_vanquish_13\skins\custom1.paa","","","","","","",""};
	};
	
	class red_vanquish_13_custom2:red_vanquish_13_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2013 Aston Martin Vanquish (Custom 2)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_vanquish_13\skins\custom2.paa","","","","","","",""};
	};
	
	class red_vanquish_13_custom3:red_vanquish_13_base
	{	
		scope	= 2; 			/// makes the car visible in editor
		scopeCurator=2;			// scope 2 means it's available in Zeus mode (0 means hidden)
		crew 	= "C_man_1"; 	/// we need someone to fit into the car
		side	= 3; 			/// civilian car should be on civilian side
		faction	= CIV_F;		/// and with civilian faction
		displayName = "2013 Aston Martin Vanquish (Custom 3)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_vanquish_13\skins\custom3.paa","","","","","","",""};
	};
	class red_vanquish_13_custom4: red_vanquish_13_base
	{
		scope = 2;
		scopeCurator = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2013 Aston Martin Vanquish (Custom 4)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_vanquish_13\skins\custom4.paa","","","","","","",""};
	};
		
	class red_vanquish_13_custom5: red_vanquish_13_base
	{
		scope = 2;
		scopeCurator = 2;
		crew = "C_man_1";
		side = 3;
		faction = "CIV_F";
		displayName = "2013 Aston Martin Vanquish (Custom 5)";
		vehicleClass = "red_civilian";
		author = "Redhotsteel";
		hiddenSelectionsTextures[] = {"\red_config\red_vanquish_13\skins\custom5.paa","","","","","","",""};
	};
};