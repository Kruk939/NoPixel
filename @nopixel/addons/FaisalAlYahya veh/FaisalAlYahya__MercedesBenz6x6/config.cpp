...
//Class AMG__MercedesBenz6x6 : config.bin{
class DefaultEventhandlers;
class CfgPatches
{
	class AMG__MercedesBenz6x6
	{
		units[] = {"AMG__MercedesBenz6x6"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class AMG__MercedesBenz6x6_base: Car_F
	{
		vehicleClass="Faisal_Cars";
		model="FaisalAlYahya__MercedesBenz6x6\AMG__MercedesBenz6x6";
		...
		displayName="Mercedes Benz G63 6x6";
...
hiddenSelectionsTextures[] = {"#(argb,8,8,3)color(0,0,0,1.0,CO)", "", "", "", "", "", "", "", "", "", "","",""};		class AnimationSources: AnimationSources
	...
	class AMG__MercedesBenz6x6: AMG__MercedesBenz6x6_base
	{
		author = "Faisal Al-Yahya";
		vehicleClass = "Faisal_Cars";
		scope = 2;
