...
//Class AMG_TahoePolice : config.bin{
class DefaultEventhandlers;
class CfgPatches
{
	class AMG_TahoePolice
	{
		units[] = {"AMG_TahoePolice"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class AMG_TahoePolice_base: Car_F
	{
		vehicleClass="Faisal_Cars";
		model="FaisalAlYahya_ChevyTahoePolice\AMG_TahoePolice";
		...
		displayName="Chevrolet Tahoe 2008 Police";
