...
//Class FaisalAlYahya_CVPI : config.bin{
class DefaultEventhandlers;
class CfgPatches
{
	class FaisalAlYahya_CVPI
	{
		units[] = {"FaisalAlYahya_CVPI"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class FaisalAlYahya_CVPI_base: Car_F
	{
		model = "FaisalAlYahya_CrownVicPolice\FaisalAlYahya_CVPI";
		extCameraPosition[] = {0,1,-8};
		ejectDeadDriver = 1;
		ejectDeadCargo = 1;
		hideWeaponsDriver = 1;
		hideWeaponsCargo = 1;
		displayName = "This one Doesnt Work";
		supplyRadius = 2;
	...
	class FaisalAlYahya_CVPI_police: FaisalAlYahya_CVPI_base
	{
