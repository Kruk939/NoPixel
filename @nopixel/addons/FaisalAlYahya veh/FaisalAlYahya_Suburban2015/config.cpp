...
//Class AMG_Suburban2015 : config.bin{
class DefaultEventhandlers;
class CfgPatches
{
	class AMG_Suburban2015
	{
		units[] = {"AMG_Suburban2015"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class AMG_Suburban2015_base: Car_F
	{
		vehicleClass="Faisal_Cars";
		model="FaisalAlYahya_Suburban2015\AMG_Suburban2015";
		...
		displayName="Chevy Suburban 2015";
...
class UserActions {
	...
	class AMG_Suburban2015: AMG_Suburban2015_base
	{
		author = "Faisal Al-Yahya";
		vehicleClass = "Faisal_Cars";
		scope = 2;
