...
class CfgSounds
{
	...
	class Siren1
	{
		...
		sound[]=
		{
			"red_explorer_16_p\sounds\siren.wav",
			1,
			1
		};
		titles[]={};
	...
	class Siren2
	{
		...
		sound[]=
		{
			"red_explorer_16_p\sounds\yelp.wav",
			1,
			1
		};
		titles[]={};
...
class cfgVehicles
{
	...
	class red_explorer_16_p: red_explorer_16_p_p_base
	{
		scope=2;
		displayName="2016 Ford Explorer (Marked)";
		crew="C_man_1";
		side=3;
		faction="CIV_F";
	...
	class red_explorer_16_p_ems: red_explorer_16_p_p_base
	{
		scope=2;
