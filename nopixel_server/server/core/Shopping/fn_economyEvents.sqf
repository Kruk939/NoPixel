...
switch (_selected) do {
    ...
    case "1": {priceArrayOre = [30,75,75,10,115]; publicVariable "priceArrayOre"; ["Informacja","Naukowcy udowodnili że w ciągu kilku miesięcy dostępność wydobywcza żelaza spadnie do 10%!",[255,69,0,1],""] remoteExec ["Client_fnc_showNotification", -2]; diag_log "SERWER: Pomyślnie wykonano economyEvent: Iron";};
    case "2": {priceArrayOre = [30,45,90,10,115]; publicVariable "priceArrayOre"; ["Informacja","Kobiety zakochały się w srebnej biżuterii! Producenci biżuterii skupują duże ilości srebra!",[255,69,0,1],""] remoteExec ["Client_fnc_showNotification", -2]; diag_log "SERWER: Pomyślnie wykonano economyEvent: Silver";};
