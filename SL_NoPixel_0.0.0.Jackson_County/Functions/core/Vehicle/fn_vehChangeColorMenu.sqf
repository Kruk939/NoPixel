...
if (str _classname find "vory_evox" > -1) then {
		_texturesIvory = ["ivory_evox_brightlime","ivory_evox_cleanwhite","ivory_evox_forsakenteal","ivory_evox_reckfulred","ivory_evox_koyama","kif_evox_anon"];
		_texturesBody = _texturesBody + _texturesIvory;
};
