...
_maxSpeed = getNumber(configFile >> "CfgVehicles" >> _class >> "maxSpeed") * 1.341;
_enginePower = getNumber(configFile >> "CfgVehicles" >> _class >> "enginePower");
