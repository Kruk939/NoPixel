params["_type"];
if (_type == 1) exitWith {player addItem "kif_500k"; [player,objNull,17,format ["%1 wyciągnął z depozytu teczkę na kwotę 500 000 $", name player],"500 000$"] remoteExec ["server_fnc_copLog", 2];};
