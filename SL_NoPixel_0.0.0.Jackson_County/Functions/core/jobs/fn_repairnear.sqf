...
_pay = false;
{ if( damage _x isEqualTo 1 && !isPlayer _x ) then { if (player distance vehspawned < 20) then { _pay = true; }; _x setdamage 0; _thisobject = _x; }; } foreach nearestObjects [player, [], 20];
