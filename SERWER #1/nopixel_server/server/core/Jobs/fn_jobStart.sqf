...
[] remoteExec ["StanLakeside_fnc_startCop",_player]; 
...
[_player, getUnitLoadout _player] call StanLakesideServer_fnc_statSave;   
[] remoteExec ["StanLakeside_fnc_startEMS",_player]; 
_player setvariable ["sync",0,false]; 
...
[_player, getUnitLoadout _player] call StanLakesideServer_fnc_statSave;   
[] remoteExec ["StanLakeside_fnc_startFire",_player]; 
_player setvariable ["sync",0,false]; 
...
[] remoteExec ["StanLakeside_fnc_startMafia",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startDispatch",_player]; 
...
[] remoteExec ["StanLakeside_fnc_mailSystem",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startTaxi",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startSecurity",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startLegalAid",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startLawyer",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startJudge",_player];  
...
[] remoteExec ["StanLakeside_fnc_startProsecutor",_player];  
...
[] remoteExec ["StanLakeside_fnc_startTowTruck",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startGarbage",_player]; 
...
[] remoteExec ["StanLakeside_fnc_startNews",_player];  
...
[] remoteExec ["StanLakeside_fnc_startRepair",_player]; 
