...
[_player, getUnitLoadout _player] call StanLakesideServer_fnc_statSave; 
[] remoteExec ["StanLakesideClient_fnc_startCop",_player]; 
...
[_player, getUnitLoadout _player] call StanLakesideServer_fnc_statSave;   
[] remoteExec ["StanLakesideClient_fnc_startEMS",_player]; 
_player setvariable ["sync",0,false]; 
...
[_player, getUnitLoadout _player] call StanLakesideServer_fnc_statSave;   
[] remoteExec ["StanLakesideClient_fnc_startFire",_player]; 
_player setvariable ["sync",0,false]; 
...
[] remoteExec ["StanLakesideClient_fnc_startMafia",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startDispatch",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_mailSystem",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startTaxi",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startSecurity",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startLegalAid",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startLawyer",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startJudge",_player];  
...
[] remoteExec ["StanLakesideClient_fnc_startProsecutor",_player];  
...
[] remoteExec ["StanLakesideClient_fnc_startTowTruck",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startGarbage",_player]; 
...
[] remoteExec ["StanLakesideClient_fnc_startNews",_player];  
...
[] remoteExec ["StanLakesideClient_fnc_startRepair",_player]; 
