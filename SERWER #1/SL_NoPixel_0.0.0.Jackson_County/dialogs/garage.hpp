...
class racetimes {
	idd = 9999;
	name= "racetimes";
	onLoad = "[] spawn StanLakesideClient_fnc_racetimes";
	movingEnable = 0;
	enableSimulation = 1;
...
class fillvehicle
{
	...
	class controls 
	{
		...
		class RscButton_1600: HideButton
		{
			...
			action = [] spawn StanLakesideClient_fnc_confirmfillvehicle;
		};
...
class garage2
{
	...
	class controls 
	{
		...
		class RscButton_1600: HideButton
		{
			...
			w = 0.09 * safezoneW;
			h = 0.046 * safezoneH;
			action = [] spawn StanLakesideClient_fnc_fetchCar2;
		};
		class Close: HideButton
		{
			idc = 1601;
...
class garage3
{
	...
	class controls 
	{
		...
		class RscButton_1600: HideButton
		{
			...
			w = 0.09 * safezoneW;
			h = 0.046 * safezoneH;
			action = [1] spawn StanLakesideClient_fnc_fetchCar;
		};
		class Close: HideButton
		{
			idc = 1601;
...
class garage
{
	...
	class controls 
	{
		...
		class RscButton_1600: HideButton
		{
			...
			w = 0.09 * safezoneW;
			h = 0.046 * safezoneH;
			action = [0] spawn StanLakesideClient_fnc_fetchCar;
		};
		class Close: HideButton
		{
			idc = 1601;
...
class EnterLicense {
	...
	class controls {
		...
		class PurchaseOption : HideButton {
			idc = 9995;
			text = "Purchase";
			onButtonClick = "[] spawn StanLakesideClient_fnc_processPlates";
...
class garageplates
{
	...
	class controls 
	{
		...
		class RscButton_1601: HideButton
		{
			...
			w = 0.09 * safezoneW;
			h = 0.046 * safezoneH;
			action = [] spawn StanLakesideClient_fnc_changePlates;
		};
