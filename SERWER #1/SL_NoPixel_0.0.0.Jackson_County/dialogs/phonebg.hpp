...
class phonebg {
	idd = 537;
	name= "phoneBG";
	onLoad = "[] spawn StanLakesideClient_fnc_loadBG; [] spawn StanLakesideClient_fnc_loadSkin; uiNamespace setVariable [""phonemenu"", _this select 0]; [""nobg""] spawn StanLakesideClient_fnc_fadephone;";	
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class BackgroundTypes : client_RscListBoxClear
		{
			...
			text = "";
			sizeEx = 0.05;
			onLBSelChanged = "[] spawn StanLakesideClient_fnc_updateBG;";
			x = 0.35;
			y = 0.175;
			w = 0.301;
			h = 0.25;
		...
		class SaveSelected : client_RscButtonMenu {
			idc = 1115;
			text = "Save BG";
			onButtonClick = "[] spawn StanLakesideClient_fnc_saveBG;";
			x = 0.4;
			y = 0.45;
			w = 0.15;
			h = 0.05;
		...
		class skinTypes : client_RscListBoxClear
		{
			...
			text = "";
			sizeEx = 0.05;
			onLBSelChanged = "[] spawn StanLakesideClient_fnc_updateSkin;";
			x = 0.35;
			y = 0.5;
			w = 0.301;
			h = 0.2;
		...
		class SaveSelectedSkin : client_RscButtonMenu {
			idc = 1176;
			text = "Save Skin";
			onButtonClick = "[] spawn StanLakesideClient_fnc_saveSkin;";
			x = 0.4;
			y = 0.74;
			w = 0.15;
			h = 0.05;
