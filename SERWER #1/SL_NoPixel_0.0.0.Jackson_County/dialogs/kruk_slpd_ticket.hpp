class kruk_slpd_ticket_give {
	...
	class controls {
		...
		class button_accept: client_RscButtonMenu {
			...
			w = 7 * GUI_GRID_W;
			h = 2 * GUI_GRID_H;
			action = "[] spawn StanLakesideClient_fnc_slpd_ticket_give;";
...
class kruk_slpd_ticket_receive {
	...
	class controls {
		...
		class button_accept: client_RscButtonMenu {
			...
			w = 7 * GUI_GRID_W;
			h = 2 * GUI_GRID_H;
			action = "[""accept""] spawn StanLakesideClient_fnc_slpd_ticket_action;";
			colorBackground[] = {0.325,0.906,0.235,1};
		};
		class button_close: client_RscButtonMenu {
			idc = 1202;
			...
			w = 7 * GUI_GRID_W;
			h = 2 * GUI_GRID_H;
			action = "[""refuse""] spawn StanLakesideClient_fnc_slpd_ticket_action;";
			colorBackground[] = {0.7,0,0,1};
		};
		class text_reason: RscText {
			idc = -1;
