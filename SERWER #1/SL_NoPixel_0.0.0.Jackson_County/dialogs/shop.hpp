...
class vote_Menu {
	idd = 9999;
	name= "vote_menu";
	onLoad = "[] spawn StanLakesideClient_fnc_loadVote";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class LockVoteOption : HideButton {
			idc = 9995;
			text = "";
			onButtonClick = "[] spawn StanLakesideClient_fnc_LockVote;"; 
...
class placefurniture {
	idd = 9999;
	name= "placefurniture";
	onload = "[] spawn StanLakesideClient_fnc_listfurniture;";
	movingEnable = 0;
	enableSimulation = 1;
	...
	class controls {
		...
		class PurchaseOption : RSCButton {
			idc = 9995;
			text = "Accept";
			onButtonClick = "[] call StanLakesideClient_fnc_spawnfurniture;"; 
			x = 0.40029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0461907 * safezoneH;
...
class rentshop {
	...
	class controls {
		...
		class PurchaseOption : RSCButton {
			idc = 9995;
			text = "Accept";
			onButtonClick = "[] call StanLakesideClient_fnc_rentOffice;"; 
			x = 0.40029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0461907 * safezoneH;
...
class tax_Menu {
	...
	class controls {
		...
		class PurchaseOption : RSCButton {
			idc = 9995;
			text = "Ustaw podatek";
			onButtonClick = "[] spawn StanLakesideClient_fnc_settax;"; 
			x = 0.40029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0461907 * safezoneH;
...
class shop_update {
	...
	onunLoad = "[shopcontent,""finishupdate""] spawn StanLakesideClient_fnc_updatePrices;";
	...
	class controls {
		...
		class PriceUpdateOption : HideButton {
			idc = 9995;
			text = "Ustaw cene";
			onButtonClick = "[shopcontent,""update""] spawn StanLakesideClient_fnc_updatePrices;"; 
		...
		class ShopnameUpdateOption : HideButton {
			idc = 8995;
			text = "Zmien nazwe";
			onButtonClick = "[shopcontent,""nameupdate""] spawn StanLakesideClient_fnc_updatePrices;"; 
			x = 0.412136 * safezoneW + safezoneX;
...
class Shop_Menu {
	...
	class controls {
		...
		class PurchaseOption : HideButton {
			idc = 9995;
			text = "Kup";
			onButtonClick = "[] spawn StanLakesideClient_fnc_purchase;"; 
			x = 0.40029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0461907 * safezoneH;
...
class GUN_Menu {
	idd = 9999;
	name= "GUN_menu";
	onLoad = "[] spawn StanLakesideClient_fnc_storesetup";
	...
	class controls {
		...
		class ShopList : client_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.05;
			onLBSelChanged = "[] spawn StanLakesideClient_fnc_clothesUpdate;";
		...
		class gunOption : HideButton {
			idc = 9993;
			text = "";
			onButtonClick = "[""gunstore""] spawn StanLakesideClient_fnc_loadStore;";
		...
		class vestOption : HideButton {
			idc = 9994;
			text = "";
			onButtonClick = "[""veststore""] spawn StanLakesideClient_fnc_loadStore;"; 
			x = 0.311029 * safezoneW + safezoneX;
		...
		class PurchaseOption : HideButton {
			idc = 9995;
			text = "Kup";
			onButtonClick = "[""standard""] spawn StanLakesideClient_fnc_purchaseAI;";
...
class RareFish_Menu {
	...
	class controls {
		...
		class PurchaseOption : HideButton {
			idc = 9995;
			text = "Kup";
			onButtonClick = "[""fish""] spawn StanLakesideClient_fnc_purchaseAI;"; 
			x = 0.40229 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.023 * safezoneH;
...
class Clothing_Menu {
	...
	class controls {
		...
		class ClothingOption : HideButton {
			idc = 9993;
			text = "Clothing";
			onButtonClick = "[""clothing""] spawn StanLakesideClient_fnc_loadStore;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
		...
		class BackpackOption : HideButton {
			idc = 9994;
			text = "Backpack";
			onButtonClick = "[""backpack""] spawn StanLakesideClient_fnc_loadStore;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.729497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
...
class HairDresser_Menu {
	...
	class controls {
		...
		class ClothingOption : HideButton {
			idc = 9993;
			text = "Glasses";
			onButtonClick = "[""Glasses""] spawn StanLakesideClient_fnc_loadStore;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.706497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
		...
		class BackpackOption : HideButton {
			idc = 9994;
			text = "Head";
			onButtonClick = "[""head""] spawn StanLakesideClient_fnc_loadStore;";
			x = 0.311029 * safezoneW + safezoneX;
			y = 0.729497 * safezoneH + safezoneY;
			w = 0.0867957 * safezoneW;
			h = 0.0231907 * safezoneH;
...
class wallet_Menu {
	idd = 9999;
	name= "wallet_menu";
	onLoad = "[] spawn StanLakesideClient_fnc_wallet";
	movingEnable = 0;
	enableSimulation = 1;
