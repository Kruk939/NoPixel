class FindPlayer_Menu {
	...
	movingEnable = 0;
	enableSimulation = 1;
	onLoad = "[] spawn StanLakesideClient_fnc_findPlayers;";
	...
	class controls {
		...
		class HomeOption : client_RscButtonMenu {
			idc = 1115;
			text = "Select";
			onButtonClick = "[] spawn StanLakesideClient_fnc_chooseUser;";
...
class FindKeyPlayer_Menu {
	...
	class controls {
		...
		class HomeOption : client_RscButtonMenu {
			idc = 1115;
			text = "Select";
			onButtonClick = "[] spawn StanLakesideClient_fnc_chooseKeyUser;";
			x = -0.06 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.65;
			w = (6.25 / 40);
			h = (1 / 25);
...
class client_Craft_Menu {
	...
	movingEnable = 0;
	enableSimulation = 1;
	onLoad = "[""FRESH""] spawn StanLakesideClient_fnc_craftMenu;";
	...
	class controls {
		...
		class CraftList : client_RscListBox 
		{
			...
			text = "";
			sizeEx = 0.05;
			onLBSelChanged = "[""REFRESH""] spawn StanLakesideClient_fnc_craftMenu;";
		...
		class HomeOption : HideButton {
			idc = 1115;
			onButtonClick = "[""FRESH""] spawn StanLakesideClient_fnc_CraftMenu;";
		...
		class ProcessOption : HideButton {
			idc = 1117;
			text = "Open";
			onButtonClick = "[""MENU""] spawn StanLakesideClient_fnc_CraftMenu; [""REFRESH""] spawn StanLakesideClient_fnc_craftMenu;";
		...
		class CraftOption : HideButton {
			idc = 1116;
			text = "Craft Item";
			onButtonClick = "[""CRAFT""] spawn StanLakesideClient_fnc_CraftMenu;";
		...
		class MagOption : HideButton {
			idc = 1118;
			text = "Craft Mag";
			onButtonClick = "[""CRAFTMAG""] spawn StanLakesideClient_fnc_CraftMenu;";
