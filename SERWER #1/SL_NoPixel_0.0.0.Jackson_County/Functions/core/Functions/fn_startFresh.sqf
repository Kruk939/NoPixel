...
[] spawn { 
	...
	lastsync = time;
	["add","battery",200] call StanLakeside_fnc_sustain;
	...
	[_respawn,getplayeruid player] remoteExec ["StanLakesideServer_fnc_syncRespawn",2];
	[] spawn StanLakeside_fnc_syncData;
	[player,objNull,4,format ["%1 zrespawnił się",name player],"",""] remoteExec ["StanLakesideServer_fnc_deathLog", 2];
};
