...
["Sukces",format["Sprzedałeś narkotyki za: $%1", _cashout],[0,255,0,1],""] call StanLakesideClient_fnc_showNotification;
...
[1,_total,player,getpos player] remoteExec ["StanLakesideServer_fnc_drugJob",2];
