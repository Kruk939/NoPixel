...
_availableUniforms = [
    ...
    "CG_EMS5",
    "CG_EMS6",
    "niedobity_ems_probie",
    "niedobity_ems_probie_official",
    "niedobity_ems_paramedic",
    "niedobity_ems_paramedic_official",
    "niedobity_ems_seniorparamedic",
    "niedobity_ems_seniorparamedic_official",
    "niedobity_ems_2ndlieutenant",
    "niedobity_ems_lieutenant",
    "niedobity_ems_lieutenant_official",
    "niedobity_ems_captain",
    "niedobity_ems_captain_official",
    "niedobity_ems_chief",
    "niedobity_ems_ordynator_official",
    "niedobity_ems_rru",
    "niedobity_ems_rru_official",
    "niedobity_ems_ae",
    "niedobity_ems_ae_official",
    "niedobity_ems_ams",
    "niedobity_ems_2ndlieutenant_official",
    "niedobity_ems_deputy",
    "niedobity_ems_ams_official",
    "CUP_U_C_Rescuer_01",
    "U_BasicBody_FS",
    "female_ems3",
    "female_ems2",
