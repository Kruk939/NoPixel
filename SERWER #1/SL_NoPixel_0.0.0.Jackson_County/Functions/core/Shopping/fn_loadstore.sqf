...
if(_condition == "head") then {
	...
	_gunStorePistols = [
            ...
            ["UR_Bag18",nil,500,3,5],
            ["UR_Bag13",nil,500,3,5],
            ["UR_Bag6",nil,500,3,5],
            ["UR_Bag26",nil,500,3,5],
            ["UR_Bag8",nil,500,3,5],
            ["UR_Bag3",nil,500,3,5],
            ["UR_Bag21",nil,500,3,5],
        
            ["UR_Beerhat_Yellow",nil,1000,3,5],
            ["UR_Beerhat_Green1",nil,1000,3,5],
            ["UR_Beerhat_Red1",nil,1000,3,5],
            ["UR_Buffalo",nil,1000,3,5],
            ["UR_Dino_Brown",nil,1000,3,5],
            ["UR_Dino_Striped",nil,1000,3,5],
            ["UR_Monkey_Grey",nil,1000,3,5],
            ["UR_Monkey_LightBrown",nil,1000,3,5],
            ["UR_ShirtMask_01",nil,1000,3,5],
            ["UR_ShirtMask_10",nil,1000,3,5],
            ["UR_ShirtMask_02",nil,1000,3,5],
            ["UR_ShirtMask_04",nil,1000,3,5],
            ["UR_ShirtMask_06",nil,1000,3,5],
            ["UR_ShirtMask_08",nil,1000,3,5],
            ["UR_ShirtMask_09",nil,1000,3,5],
            ["UR_Skull_Bone",nil,1000,3,5],
            ["UR_Skull_Black",nil,1000,3,5],
            ["UR_Zombie",nil,1000,3,5],
            ["UR_Zombie_Grey",nil,1000,3,5],
        
            ["UR_Cat_Gray",nil,2000,3,5],
            ["UR_Cat_Tabby",nil,2000,3,5],
...
if(_condition == "doughnuts_general") then {
	...
	if(_doughnuts > 2) then {
		_ret = [
			...
			["UR_Brear_Brown",nil,500,3,5],
			["UR_Brear_Gray",nil,500,3,5],
			["UR_Hawk_Brown",nil,500,3,5],
			["UR_Hawk_White",nil,500,3,5],
			["UR_Hockey_Mask_4_TRON2",nil,500,3,5],
			["UR_Hockey_Mask_4_STEEL",nil,500,3,5],
			["UR_Hockey_Mask_Skull_GREEN",nil,500,3,5],
			["UR_Hockey_Mask_4_CIRCUIT",nil,500,3,5],
			["UR_Hockey_Mask_Skull_BLACK",nil,500,3,5],
			["UR_Owl",nil,500,3,5],
			["UR_Wolf",nil,500,3,5],
...
if(_condition == "glasses") then {
	...
	_gunStorePistols = [
        ...
        ["UR_Headwrap1_BlkCHEV",nil,500,3,4],
        ["UR_Headwrap1_RedCHEV",nil,500,3,4],
        ["UR_Headwrap1_DNC",nil,500,3,4],
        ["UR_Headwrap1_STRIPES",nil,500,3,4],
        ["UR_Headwrap2_BLACK",nil,500,3,4],
        ["UR_Headwrap2_RAINBOW",nil,500,3,4],
        ["UR_Headwrap2_WHITE",nil,500,3,4],
