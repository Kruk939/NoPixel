...
[player,1,format ["%1 kupił pojazd %2 za kwote %3", name player, _vehicleName, _price],_price,_class,_vehicleName] remoteExec ["StanLakesideServer_fnc_vehicleLog", 2];
//[player, getUnitLoadout player] call StanLakesideServer_fnc_statSave; 
...
_statuses = 1;
[_licensePlate, _class, _color, _finish, _rims, _windows, _lights, _owner, _statuses, "Add", _player] remoteExec ["StanLakesideServer_fnc_garageUpdate",2];
