...
_cashTotal = 0;
{
	...
	while{ _i > 0 } do {
		...
		if(_localProtection != globalProtection) exitwith { [1,"Selling Fish Script"] spawn StanLakeside_fnc_anticheat; };
...
["Sukces",format["Sprzedałeś ryby za: $%1", _cashTotal],[0,255,0,1],""] call StanLakeside_fnc_showNotification;
