...
*/
	...
	if(totalLogs == 1) exitwith {
		...
		[player,objNull,29,format ["%1 zapakował drewno na pakę pojazdu. Ilość drewna na pojeździe: %2",name player, totalLogs],totalLogs] remoteExec ["StanLakesideServer_fnc_actionLog", 2];
	};
