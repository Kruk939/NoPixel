if (count currentCop < 3) exitWith {["Błąd","Tekst",[255,0,0,1],"Musi być minimum 3 policjantów!"] call StanLakesideClient_fnc_showNotification;};
...
if(typeof cursorobject IN ["Land_GateB","Land_MainSection","Land_Gaol_Main", "Land_buildingsJailCellBlock1"]) then {
	...
	[player, _door, "hackDoor"] spawn StanLakesideClient_fnc_createEvidence;
};
jailHacking = false;