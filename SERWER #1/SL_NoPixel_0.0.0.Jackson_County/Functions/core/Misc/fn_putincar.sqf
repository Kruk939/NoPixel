...
detach _unit;
[_nearestVehicle] remoteExec ["StanLakesideClient_fnc_moveIn",_unit];
[player,_unit,2,format ["%1 wrzucił %2 do pojazdu", name player, name _unit],""] remoteExec ["StanLakesideServer_fnc_actionLog", 2];
