...
if(_type == "Food") then {
	...
	[] spawn StanLakeside_fnc_hudhunger;
};
...
if(_type == "Drink") then {
	...
	[] spawn StanLakeside_fnc_hudthirst;		
};
...
if(_type == "Battery") then {
	...
	[] spawn StanLakeside_fnc_hudbattery;			
};
...
if(_type == "unhealthiness") then {
	...
	_selection = 6;	
	[] spawn StanLakeside_fnc_hudunhealthiness;
};
...
if(_type == "drug") then {
	["remove","unhealthiness",1] call StanLakeside_fnc_sustain;
