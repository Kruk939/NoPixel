...
NoPixel_InteractionMenuItems = [
	...
	[
		...
		["Prawo jazdy 500$", "_cashcheck = [1,500] call Client_fnc_sl_checkMoney_secure; if!(_cashCheck) exitwith { hint ""Nie masz pieniędzy!""; }; [""Add"",""license"",1] call StanLakeside_fnc_sustain; [500] call StanLakeside_fnc_sl_removeCash_secure; ",1]
	],
