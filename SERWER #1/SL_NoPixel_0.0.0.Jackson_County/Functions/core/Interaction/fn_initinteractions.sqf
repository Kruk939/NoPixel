...
NoPixel_InteractionMenuItems = [
	...
	[ 
		...
		["Zabezpiecz pieniądze", " ['Zabezpieczanie pieniędzy',300,StanLakesideClient_fnc_securefunds,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",0] spawn StanLakesideClient_fnc_dotask ",5] 
	],

	[ 
		[" bankrobber == 4 "], 
		["Zbierz pieniądze", " ['Pakuję pieniądze',180,StanLakesideClient_fnc_takecash,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",0] spawn StanLakesideClient_fnc_dotask ",5] 
	],

	[ 
		[" bankrobber == 2 "], 
		["Napraw wiertło", " ['Repairing Drill',120,StanLakesideClient_fnc_repairdrill,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",0] spawn StanLakesideClient_fnc_dotask ",5] 
	],


	[ 
		[" ((lastforcesync + 300) < time) && client_canSync "], 
		["Sync Data (5min CD)", " [] spawn StanLakesideClient_fnc_syncData; ",5] 
	],

	[
		["adminInteractions>=1"],
		["Sync Data", " [] spawn StanLakesideClient_fnc_syncData; ",5] 
	],

	[ 
		["  "], 
		["Daj klucze", " [] spawn StanLakesideClient_fnc_findplayerskeys; ",5] 
	],
	
	[
		["(licensearray select 0) == 0 && typeof CurrentCursorTarget IN [""Land_Centrelink""] && player getVariable[""veh_points"",0] < 15"],
		["Prawo jazdy 500$", "_cashcheck = [1,500] call StanLakesideClient_fnc_sl_checkMoney_secure; if!(_cashCheck) exitwith { hint ""Nie masz pieniędzy!""; }; [""Add"",""license"",1] call StanLakesideClient_fnc_sustain; [500] call StanLakesideClient_fnc_sl_removeCash_secure; ",1]
	],

	[
		["typeof CurrentCursorTarget == ""Land_buildingGunStore1"" && (licensearray select 1) == 0"],
		["Licencja Broń 2500$", "_cashcheck = [1,2500] call StanLakesideClient_fnc_sl_checkMoney_secure; if!(_cashCheck) exitwith { hint ""Nie masz pieniędzy!""; }; [""Add"",""license"",2] call StanLakesideClient_fnc_sustain; [2500] call StanLakesideClient_fnc_sl_removeCash_secure; ",1]
	],
	...
	[
		...
		["Licencja Górnika 700$", "_cashcheck = [1,700] call StanLakesideClient_fnc_sl_checkMoney_secure; if!(_cashCheck) exitwith { hint ""Nie masz pieniędzy!""; }; [""Add"",""license"",3] call StanLakesideClient_fnc_sustain; [700] call StanLakesideClient_fnc_sl_removeCash_secure; ",1]
	],
	...
	[
		...
		["Licencja Drwala", "[""Add"",""license"",4] call StanLakesideClient_fnc_sustain;",1]
	],
	...
	[
		...
		["Licencja Rybaka 400$", "_cashcheck = [1,400] call StanLakesideClient_fnc_sl_checkMoney_secure; if!(_cashCheck) exitwith { hint ""Nie masz pieniędzy!""; }; [""Add"",""license"",5] call StanLakesideClient_fnc_sustain; [400] call StanLakesideClient_fnc_sl_removeCash_secure; ",1]
	],
	...
	[
		...
		["Sprzedawanie narkotyków", " ['Sprzedawanie',60,StanLakesideClient_fnc_finishDrugRun,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask ",1]
	],

	[
		[" myJob != ""cop""", "typeof currentcursortarget == ""Land_buildingsbasement1"" && player distance getmarkerpos ""drugdump"" < 30"],
		["Sprzedaj narkotyki", " ['Sprzedawanie',30,StanLakesideClient_fnc_dumpDrugs,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask ",1]
	],

	[
		[" myJob != ""cop""", "typeof currentcursortarget == ""Land_buildingsbasement1"" && player distance getmarkerpos ""drugdump"" < 30"],
		["Wypierz pieniądze", " ['Piorę pieniądze',60,StanLakesideClient_fnc_dumpMoney,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn StanLakesideClient_fnc_dotask ",1]
	],

	[
		[" myJob == ""Mafia"" && (player getVariable ""Mafia"") > 5 "],
		["Podsłuchy", " [] spawn StanLakesideClient_fnc_findTapped; ",1]
	],
	...
	[
		...
		["Konfiskuj", " [] spawn StanLakesideClient_fnc_seizeObjects; ",1]
	],
	...
	[
		...
		["Siku sik", " [currentcursortarget] spawn StanLakesideClient_fnc_pee; ",1]
	],
...
//		["Daj Pożyczkę", " [currentcursortarget] spawn StanLakesideClient_fnc_sl_giveLoan_secure; ",1]
//	],

	[
		[" (isplayer currentcursortarget && vehicle currentcursortarget == currentcursortarget) && myJob == ""Mafia"" && player getVariable [""Mafia"",0] > 5 "],
		[" Namierz telefon ", " [] spawn StanLakesideClient_fnc_tracecall; ",1]
	],
	...
	[
		...
		//["Pluskwa", " ['Pluskwa',10,StanLakesideClient_fnc_strTracking,player,'AinvPknlMstpSnonWnonDnon_medic_1',[currentcursortarget, player],"""",0] spawn StanLakesideClient_fnc_dotask ",1]
		["Pluskwa",  " [currentcursortarget, player] spawn StanLakesideClient_fnc_strTracking; ",1]
	],

	[
		[" myJob == ""cop"" &&  client_dtu_actions >= 1"],
		//["Pluskwa", " ['Pluskwa',10,StanLakesideClient_fnc_strTracking,player,'AinvPknlMstpSnonWnonDnon_medic_1',[currentcursortarget, player],"""",0] spawn StanLakesideClient_fnc_dotask ",1]
		["Pluskwa",  " [currentcursortarget, player] spawn StanLakesideClient_fnc_strTrackingCop; ",1]
	],
	...
	[
		...
		["Szukaj pluskwy", " [currentcursortarget] spawn StanLakesideClient_fnc_disTracking; ",1]
	],
	
	[
		[" player distance theDrill < 5"],
		["Zabierz wiertło", " ['Pakowanie wiertła',30,StanLakesideClient_fnc_takeDrill,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",0] spawn StanLakesideClient_fnc_dotask ",1]
	],

	[
		[" player distance getmarkerpos ""rally_1"" < 80 "],
		["Próba rajdowa", " [] spawn StanLakesideClient_fnc_doRally; ",1]
	],
...
// healing
	...
	[
		...
		["Reanimuj", "['Reanimacja',125,StanLakesideClient_fnc_sendRevive,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask",1]
	],

	[
		["CurrentCursorTarget getVariable[""dead"",FALSE] && (myjob == ""EMS"" || myJob == ""Fire"")"],
		["Reanimuj", "['Reanimacja',15,StanLakesideClient_fnc_sendRevive,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask; paycheck = paycheck + 125;",1]
	],

	[
		["(count currentEMS < 3) && !(myjob == ""EMS"")"],
		["Ulecz", "[] spawn StanLakesideClient_fnc_openHealMenu;",1]
	],
	...
	[
		...
		["Ulecz całkowicie", "[] spawn StanLakesideClient_fnc_fullheal;",1]
	],

	[
		[" typeof cursorobject == ""Land_buildingshospital1"""],
		["Zmień płeć", " if(female) then {female = false; hint ""You are now male""; } else {female = true; hint ""You are now female""; }; [""NA"",""sex"",0] call StanLakesideClient_fnc_sustain;",1]
	],

	[
		[" typeof cursorobject == ""Land_buildingshospital1"""],
		["Szukaj pluskwy", "['Szukanie pluskwy',60,StanLakesideClient_fnc_disabletrackingme,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",100] spawn StanLakesideClient_fnc_dotask;",1]
	],
	...
	[
		...
		["Zatankuj", "[] spawn StanLakesideClient_fnc_fillvehicle;",2]
	],

	[
		["count attachedObjects player > 0 && attachedcar"],
		["Upuść pojazd", " [] spawn StanLakesideClient_fnc_detach; ",2]
	],

	[
		["currentcursortarget in current_cars || myjob IN [""Cop"",""Fire"",""EMS""] "],
		["Wyciągnij graczy", " ['Wyciąganie graczy',10,StanLakesideClient_fnc_pulloutplayers,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask; ",2]
	],
	...
	[
		...
		["Sprzedaj pojazd", "['Sprzedawanie',60,StanLakesideClient_fnc_sellVehicle,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",0] spawn StanLakesideClient_fnc_dotask;",2]
	],

	[
		["CurrentCursorTarget isKindOf 'Car' || CurrentCursorTarget isKindOf 'Air' || CurrentCursorTarget isKindOf 'Boat' "],
		["Napraw", "['Naprawianie',30,StanLakesideClient_fnc_repair,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",100] spawn StanLakesideClient_fnc_dotask;",2]
	],

	[
		["(vehicle player) == player && CurrentCursorTarget in Current_Cars"],
		["Użyj klucza", "[CurrentCursorTarget] call StanLakesideClient_fnc_useKey",2]
	],

	[
		["(vehicle player) in Current_Cars"],
		["Użyj klucza", "[vehicle player] call StanLakesideClient_fnc_useKey",2]
	],	
	...
	[
		...
		["Pchnij", "[] spawn StanLakesideClient_fnc_pushveh",2]
	],

	[
		["CurrentCursorTarget in Current_Cars", "!imRestrained", "myhouse distance getpos player > 50"],
		["Schowaj do garażu", "['Chowam pojazd do garażu ($10)',30, StanLakesideClient_fnc_storeCar,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",10] spawn StanLakesideClient_fnc_dotask",2]
	],

	[
		["CurrentCursorTarget in Current_Cars", "!imRestrained", "myhouse distance getpos player < 50"],
		["Schowaj do garażu", "['Chowam pojazd do garażu',10, StanLakesideClient_fnc_storeCar,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],

	[
		["adminInteractions>=1"],
		["Schowaj do garażu", "['Chowam pojazd do garażu',1, StanLakesideClient_fnc_storeCar,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_sndimg\sounds\repair.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],
...
//furniture
	...
	[
		...
		["Usuń wszystkie meble", "  [0] spawn StanLakesideClient_fnc_spawnfurniture; attachedfurniture = false; ",2]
	],
	...
	[
		...
		["Postaw", " [] spawn StanLakesideClient_fnc_spawnfurniture; attachedfurniture = false; ",2]
	],
	...
	[
		[" attachedbarrier "],
		["Postaw barierkę", " [] spawn StanLakesideClient_fnc_placebarrier; ",2]
	],
	...
	[
		...
		["Odbierz licencję", " ['Odbieranie',5,StanLakesideClient_fnc_revokelicense,CurrentCursorTarget,'vvv_anim_ticket',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],
	...
	[
		...
		["Przeszukaj", " ['Przeszukiwanie',10,StanLakesideClient_fnc_startpatdown,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask ",2]
	],
	...
	[
		...
		["Zabierz pieniądze", " ['Zbieranie pieniędzy',10,StanLakesideClient_fnc_takePlayerMoney,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],
	...
	[
		...
		["Skuj", " ['Skuwanie',3,StanLakesideClient_fnc_restrain,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\handcuff.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],

	[
		[" myJob != ""Cop""", "!imRestrained", "(!(cursortarget getVariable[""dead"",FALSE]) && CurrentCursorTarget isKindOf 'Man') && (animationstate CurrentCursorTarget) == 'incapacitated' || (animationstate CurrentCursorTarget) == 'deadstate' || (animationstate CurrentCursorTarget) == 'amovpercmstpssurwnondnon' || (animationstate CurrentCursorTarget) == 'amovpercmstpsnonwnondnon_amovpercmstpssurwnondnon'"],
		["Skuj", " ['Skuwanie',7,StanLakesideClient_fnc_restrain,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\handcuff.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],
	...
	[
		...
		["Rozkuj", " ['Rozkuwanie',5,StanLakesideClient_fnc_unrestrain,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\handcuff.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],

	[
		[" myJob != ""Cop""", "!imRestrained", "CurrentCursorTarget isKindOf 'Man'", "(animationstate CurrentCursorTarget) == 'Acts_AidlPsitMstpSsurWnonDnon_loop' || (animationstate CurrentCursorTarget) == 'amovpercmstpssurwnondnon' || (animationstate CurrentCursorTarget) == 'amovpercmstpsnonwnondnon_amovpercmstpssurwnondnon'"],
		["Rozkuj", " ['Rozkuwanie',60,StanLakesideClient_fnc_unrestrain,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\handcuff.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],
	...
	[
		...
		["Załóż worek", " ['Zakładanie worka',5,StanLakesideClient_fnc_blindfold,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn StanLakesideClient_fnc_dotask ",2]
	],

	[
		[" CurrentCursorTarget isKindOf 'Man'", "!imRestrained", "(headgear CurrentCursorTarget) == 'mgsr_headbag' "],
		["Zdejmij worek", " ['Zdejmowanie worka',5,StanLakesideClient_fnc_unblindfold,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],
	...
	/*[
		...
		["Wsadź skarpetę", " ['Wkładam skarpetę do mordy',5,StanLakesideClient_fnc_gag,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn StanLakesideClient_fnc_dotask ",2]
	],

	[
		[" CurrentCursorTarget isKindOf 'Man' && (cursorTarget getVariable [""gagged"", false])"],
		["Wyciągnij skarpetę", " ['Wyciągam skarpetę z mordy',5,StanLakesideClient_fnc_ungag,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""kif_client\sounds\blindfold.ogg"",0] spawn StanLakesideClient_fnc_dotask",2]
	],*/
	...
	[
		...
		["Wrzuć do auta", " ['Wrzucanie do auta',10,StanLakesideClient_fnc_putincar,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask ",2]
	],

	[
		[" myJob != ""Cop"" &&  CurrentCursorTarget isKindOf 'Man'", "(animationstate CurrentCursorTarget) == 'amovpercmstpsnonwnondnon_amovpercmstpssurwnondnon' || (animationstate CurrentCursorTarget) == 'Incapacitated' || (animationstate CurrentCursorTarget) == 'AmovPercMstpSnonWnonDnon_Ease' || (animationstate CurrentCursorTarget) == 'Acts_AidlPsitMstpSsurWnonDnon_loop'"],
		["Wrzuć do auta", " ['Wrzucanie do auta',5,StanLakesideClient_fnc_putincar,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask ",2]
	],
	...
	[
		...
		["Eskortuj", " ['Rozpoczynam eskortę',5,StanLakesideClient_fnc_attach,CurrentCursorTarget,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask ",2]
	],
	...
	[
		["count attachedObjects player > 0 && !attachedcar"],
		["Puść", " ['Puszczam',5,StanLakesideClient_fnc_detach,player,'AinvPknlMstpSnonWnonDnon_medic_1',CurrentCursorTarget,""cg_mission_files\sounds\patdown1.ogg"",0] spawn StanLakesideClient_fnc_dotask ",2]
	],

	[
		["CurrentCursorTarget isKindOf 'Man' && bankrobber == 1"],
		["Daj pieniądze", "[CurrentCursorTarget] call StanLakesideClient_fnc_sl_giveCash_secure",2]
	],

	[
		["CurrentCursorTarget isKindOf 'Man' && (myjob == ""Mafia"" || myjob == ""Fire"" || myjob == ""Cop"" || myjob == ""EMS"" || myjob == ""Judge"" || myjob == ""Lawyer"" || myjob == ""Prosecutor"")"],
		["Awansuj", "[CurrentCursorTarget] spawn StanLakesideClient_fnc_promotionStart",2]
	],
...
//shops and offices garages etc
	...
	[
		...
		["Wyposażenie sklepu", "[""shop""] spawn StanLakesideClient_fnc_retreiveCargo;",3]
	],

	[
		["myjob == ""Cop""", "client_dtu_actions > 0", "typeof CurrentCursorTarget == ""Land_PoliceStation"""],
		["Skonfiskowane rzeczy", "[""dtu""] spawn StanLakesideClient_fnc_retreiveCargo;",3]
	],

	[
		["player distance myshop < 3"],
		["Ceny", "[shopcontent,""start""] call StanLakesideClient_fnc_updatePrices;",3]
	],
	...
	[
		...
		["Sprawdz roślinę", "[CurrentCursorTarget] call StanLakesideClient_fnc_checkWeedPlant",3]
	],
	[
		...
		["Zetnij roślinę", "[CurrentCursorTarget] call StanLakesideClient_fnc_cutDownWeedPlant",3]
	],

	[
		//["(player distance myshop < 3) && ("""" != player getvariable ""shop"");"],
		["(player distance myshop < 3)  && (sklepotw == 1)"],
		["Zamknij Sklep", "[player] call StanLakesideClient_fnc_closeshop;",3]
	],
	...
	[
		...
		["Fryzjer", "closedialog 0; createdialog ""HairDresser_Menu""; [""Glasses""] spawn StanLakesideClient_fnc_loadStore;",3]
	],
	...
	[
		...
		["Sprawdź mail'a", "[] spawn StanLakesideClient_fnc_openMail",3]
	],
	...
	[
		...
		["Przemaluj pojazd", " [] spawn StanLakesideClient_fnc_vehChangeColorMenu; ",3]
	],
	...
	[
		...
		["Sprawdz ofertę", "[cursorTarget] spawn StanLakesideClient_fnc_vehGetInfo;",3]
	],
	...
	[
		...
		["Kup samochód", "[] spawn StanLakesideClient_fnc_vehBuy",3]
	],
	...
	[
		...
		["Skup rzadkich ryb", "closedialog 0; createdialog ""RareFish_Menu""; [""rarefish""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],

	[
		["currentcursortarget == fishTrader"],
		["Wymień rzadką skórę", "closedialog 0; [] spawn StanLakesideClient_fnc_rarePelt;",3]
	],

	[
		["typeof CurrentCursorTarget IN [""Land_Coffee_DED_Coffee_02_F"",""Land_Coffee_DED_Coffee_01_F""]"],
		["Sklep z ubraniami", "closedialog 0; createdialog ""Clothing_Menu""; [""clothing""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],

	[
		["typeof CurrentCursorTarget == ""Land_buildingGunStore1"""],
		["Sklep z bronią", "closedialog 0; createdialog ""gun_menu""; [""gunstore""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],

	[
		["typeof CurrentCursorTarget == ""land_cg_dunkinbronuts"""],
		["Cukiernia", "closedialog 0; createdialog ""food_menu""; [""donuts""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],
	
	[
		["typeof CurrentCursorTarget == ""land_cg_dunkinbronuts"" && myjob == ""Doughnuts"""],
		["Pączkowe ubranka", "closedialog 0; createdialog ""Clothing_Menu""; [""doughnuts_general""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],
	[
		["typeof CurrentCursorTarget == ""land_cg_dunkinbronuts"" && myjob == ""Doughnuts"""],
		["Pączkowe bronie", "closedialog 0; createdialog ""gun_menu""; [""doughnuts_gun""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],

	[
		["typeof CurrentCursorTarget == ""land_cg_dexters"""],
		["Pizzeria", "closedialog 0; createdialog ""food_menu""; [""pizza""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],

	[
		["typeof CurrentCursorTarget == ""Land_Market_DED_Market_01_F"""],
		["Mc Dildos", "closedialog 0; createdialog ""food_menu""; [""mcdonalds""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],

	[
		["str penis find ""carrito"" > -1 || str penis find ""modelos6ki"" > -1"],
		["Fast Food", "closedialog 0; createdialog ""food_menu""; [""hotdogs""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],

	[
		["typeof CurrentCursorTarget == ""Land_buildingBar1"""],
		["Bar", "closedialog 0; createdialog ""food_menu""; [""bar""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],
	...
	[
		...
		["Wielobranżowy", "closedialog 0; createdialog ""GeneralStore_Menu""; [""general""] spawn StanLakesideClient_fnc_LoadStore;",3]
	],


	[ 
		["str CurrentCursorTarget find ""tallerdepinturaabandonado"" > -1 && (getpos player) distance [1055,3660,0.014] < 20"], 
		["Parking policyjny", "[CurrentCursorTarget] call StanLakesideClient_fnc_openCarYard",3] 
	],
	...
	[ 
		...
		["Ulepsz pojazd", "[] spawn StanLakesideClient_fnc_carupdate;",3] 
	],

	[
		["myjob == ""Cop""", "typeof cursorobject == ""Land_PoliceStation"""],
		["Otwórz garaż policyjny", "[] spawn StanLakesideClient_fnc_openGaragePolice;",3]
	],

	[
		["client_dtu_actions > 0","myjob == ""Cop""", "typeof cursorobject == ""Land_PoliceStation"""],
		["Otwórz garaż DTU", "[] spawn StanLakesideClient_fnc_openGarageDTU;",3]
	],

	[
		["myjob == ""EMS""", "typeof cursorobject == ""Land_buildingshospital1"""],
		["Otwórz garaż EMS", "[] spawn StanLakesideClient_fnc_openGarageEMS;",3]
	],

	[
		["myjob == ""Fire""", "typeof cursorobject == ""Land_buildingsfiredept1"""],
		["Otwórz garaż F.D.", "[] spawn StanLakesideClient_fnc_openGarageEMS;",3]
	],

	[
		["myJob == ""Mafia""", "player distance myhouse < 40 "],
		["Otwórz garaż Mafii", "[] spawn StanLakesideClient_fnc_openGarageMafia;",3]
	],
	...
	[ 
		...
		["Otwórz garaż", "[CurrentCursorTarget] call StanLakesideClient_fnc_openGarage",3] 
	],

	[ 
		["client_dtu_actions > 0","myjob == ""Cop""", "count attachedObjects player == 0 && !attachedcar, player distance myhouse < 30 || str CurrentCursorTarget find ""otros"" > -1 || str CurrentCursorTarget find ""garaje"" > -1 || str CurrentCursorTarget find ""tallerdepinturaabandonado"" > -1 || typeof CurrentCursorTarget IN [""Land_ModernShowroom""] || (typeOF cursorTarget) find ""Hangar_F"" > -1"], 
		["Otwórz garaż DTU", "[CurrentCursorTarget] call StanLakesideClient_fnc_openGarageDTU",3] 
	],
	...
	[ 
		...
		["Otwórz garaż EMS", "[CurrentCursorTarget] call StanLakesideClient_fnc_openGarageEMS",3] 
	],
	...
	[ 
		...
		["Otwórz garaż F.D.", "[CurrentCursorTarget] call StanLakesideClient_fnc_openGarageEMS",3] 
	],
	...
	[ 
		...
		["Otwórz garaż Mafii", "[CurrentCursorTarget] call StanLakesideClient_fnc_openGarageMafia",3] 
	],
	...
	[ 
		...
		["Otwórz garaż policyjny", "[CurrentCursorTarget] call StanLakesideClient_fnc_openGaragePolice",3] 
	],
	...
	[
		...
		["Otwórz garaż firmy", "[] spawn StanLakesideClient_fnc_opengaragepolice;",3]
	],
	...
	[
		...
		["Ulepsz dom (50k)", "[] spawn StanLakesideClient_fnc_UpgradeHouse",3]
	],

	[
		["typeof currentcursortarget == ""Land_Market_DED_Market_03_F"""],
		["Wymień telefon", "closedialog 0; [] call StanLakesideClient_fnc_checkPhone;",3]
	],

	[
		["typeof currentcursortarget == ""Land_Market_DED_Market_03_F"""],
		["Naładuj telefon", "closedialog 0; [""add"",""battery"",200] call StanLakesideClient_fnc_sustain;",3]
	],
...
// jobs / situational
	...
	[
		...
		["Bank mafii", "[] call StanLakesideClient_fnc_openMafiaATM",4]
	],
	...
	[
		...
		["Bankomat", "[] call StanLakesideClient_fnc_openATM",4]
	],
	...
	[
		...
		["Otwórz wyposażenie domu", "[""house""] spawn StanLakesideClient_fnc_retreiveCargo;",4]
	],
...
//	],
	...
	[
		...
		["Zwołaj Jury", "  [] spawn StanLakesideClient_fnc_startJury; ",4]
	],

	[
		["(str CurrentCursorTarget find ""gymbench"" > -1 || str CurrentCursorTarget find ""gymrack"" > -1)"],
		["Ćwicz", "[""Na rozgrzewkę są podskoki, skłony w dół i na boki!"",60,StanLakesideClient_fnc_workout,player,'AmovPercMstpSnonWnonDnon_exercisekneeBendA',player,0] spawn StanLakesideClient_fnc_dotask; ",4]
	],

	[
		["Mayor && player distance myhouse < 25"],
		["Załóż strój burmistrza", "[150] call StanLakesideClient_fnc_sl_removeBank_secure; player forceAddUniform ""vvv_traje_ejecutivo_1"";",4]
	],
	...
	[
		...
		["Przeszukaj dom", " [player] remoteexec [""StanLakesideClient_fnc_raidhouse"",currentcursortarget]; ",4]
	],

	[
		[" (isplayer currentcursortarget && currentcursortarget isKindOf ""Man"") && myjob == ""Cop"" && player getvariable ""cop"" > 5"],
 		["Przeszukaj sklep", " [player] remoteexec [""StanLakesideClient_fnc_raidshop"",currentcursortarget]; ",4]
	],

	[
		[" (isplayer currentcursortarget && currentcursortarget isKindOf ""Man"") && (myjob == ""Cop"" || myjob == ""EMS"" || myjob == ""Fire"")"],
		["Poziom ‰ krwi", " [currentcursortarget] spawn StanLakesideClient_fnc_testIntox; ",4]
	],
	...
	[
		...
		["Anonimowy telefon", "[] spawn StanLakesideClient_fnc_callMenuPP; ",4]
	],
	...
	[
		...
		["Okradnij sklep", " [] spawn StanLakesideClient_fnc_robShop; ",4]
	],
	
	[
		["myjob == ""Cop"" && count(CurrentCursorTarget getVariable[""evidence"",[]]) != 0"],
		["Zbierz dowody", "[""Zbieram dowody"",30,StanLakesideClient_fnc_gatherEvidence,player,'AinvPknlMstpSnonWnonDnon_medic_1',player,0] spawn StanLakesideClient_fnc_dotask; ",4]
	],
	[
		["CurrentCursorTarget != objNull && count(CurrentCursorTarget getVariable[""evidence"",[]]) != 0"],
		["Zniszcz dowody", "[""Niszcze dowody"",60,StanLakesideClient_fnc_destroyEvidence,player,'AinvPknlMstpSnonWnonDnon_medic_1',player,0] spawn StanLakesideClient_fnc_dotask; ",4]
	],

	[
		["myjob == ""Fire"" && !dispatch && (player getvariable ""Fire"") > 0 "],
		["Zapis medyczna centrala", "[player,""Medic Dispatch""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		[" myjob == ""Cop"" && !dispatch && (player getvariable ""cop"") > 0 "],
		["Zapis policyjna centrala", "[player,""Police Dispatch""] spawn StanLakesideClient_fnc_jobstart;",4]
	],
	...
	[
		["myjob == ""Fire"" && typeof cursorobject == ""Land_buildingsfiredept1"""],
		["Skończ służbę", "[] call StanLakesideClient_fnc_jobEnd",4]
	],
	...
	[
		...
		["Podstawowy ekwipunek", "[""basic""] spawn StanLakesideClient_fnc_setGear",4]
	],

	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Land_PoliceStation"") && player getvariable ""cop"" > 6 "],
		["Ekwipunek SWAT", "[""riot""] spawn StanLakesideClient_fnc_setGear",4]
	],
	
	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Box_NATO_equip_F"") && player getvariable ""cop"" > 1 "],
		["ARSENAL", "[cursorobject] spawn StanLakesideClient_fnc_vars"]
	],

	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Box_NATO_equip_F"") && teczka_allowed >= 1 "],
		["TECZKA 100K", "[2] spawn StanLakesideClient_fnc_takeSuitcase"]
	],

	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Box_NATO_equip_F"") && teczka_allowed >= 1 "],
		["TECZKA 50K", "[3] spawn StanLakesideClient_fnc_takeSuitcase"]
	],

	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Box_NATO_equip_F"") && teczka_allowed == 2 "],
		["TECZKA 250K", "[1] spawn StanLakesideClient_fnc_takeSuitcase"]
	],

	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Box_NATO_equip_F"") && teczka_allowed >= 1 "],
		["TECZKA 10K", "[4] spawn StanLakesideClient_fnc_takeSuitcase"]
	],

	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Box_NATO_equip_F"") && teczka_allowed >= 1 "],
		["TECZKA 5K", "[5] spawn StanLakesideClient_fnc_takeSuitcase"]
	],
	
	[
		[" (myjob == ""Cop"" && typeof cursorobject == ""Box_NATO_Uniforms_F"") && player getvariable ""cop"" > 10 "],
		["MUNDURY PD", "[cursorobject] spawn StanLakesideClient_fnc_policeClothes"]
	],
	
	[
		[" (myjob == ""EMS"" && typeof cursorobject == ""Box_NATO_Uniforms_F"") && player getvariable ""ems"" > 1 "],
		["Mundury EMS", "[cursorobject] spawn StanLakesideClient_fnc_medicClothes"]
	],
	
	[
		[" (myjob == ""Fire"" && typeof cursorobject == ""Box_NATO_Uniforms_F"") && player getvariable ""Fire"" > 1 "],
		["Mundury FD", "[cursorobject] spawn StanLakesideClient_fnc_medicClothes"]
	],

	[
		[" myjob == ""none"" && (player getvariable ""cop"") > 0 && typeof cursorobject == ""Land_PoliceStation"""],
		["Rozpocznij służbę", "[player,""Cop""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		["myjob == ""none"" && (player getvariable ""Fire"") > 0 && typeof cursorobject == ""Land_buildingsfiredept1"""],
		["Rozpocznij służbę FD", "[player,""Fire""] spawn StanLakesideClient_fnc_jobstart;",4]
	],
	...
	[
		...
		["Rozpocznij służbę EMS", "[player,""EMS""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		["myjob == ""none"" && (player getvariable ""legal"") > 3"],
		["Praca sędziego", "[player,""Judge""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		["myjob == ""none"" && (player getvariable ""legal"") > 3"],
		["Praca prokuratora", "[player,""Prosecutor""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		["myjob == ""none"" && (player getvariable ""doughnuts"") > 0"],
		["Przewoznik paczkow", "[player,""doughnuts""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		["myjob == ""none"" && (player getvariable ""legal"") > 0"],
		["Praca adwokata", "[player,""Lawyer""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		["myjob == ""Judge"" || myjob == ""Lawyer"" || myjob == ""Prosecutor"" "],
		["Zakończ pracę", "[] call StanLakesideClient_fnc_jobEnd",4]
	],
	
	[
		["myjob == ""none"" && (player getvariable ""mafia"") > 0 && player distance myhouse < 30"],
		["Rozpocznij działalność", "[player,""Mafia""] spawn StanLakesideClient_fnc_jobstart;",4]
	],

	[
		["myjob == ""Mafia"""],
		["Zakończ działalność", "[] call StanLakesideClient_fnc_jobEnd",4]
	],
	...
	[
		...
		["Przetwórz narkotyki", "closedialog 0; [] spawn StanLakesideClient_fnc_processBricks",4]
	],

	[
		["((player distance (getMarkerPos ""sales"")) < 30)"],
		["Sprzedaj surowce", "closedialog 0; [] spawn StanLakesideClient_fnc_sellOre",4]
	],

	[
		["((player distance (getMarkerPos ""peltCuring"")) < 30)"],
		["Przetwórz skóry", "closedialog 0; [] spawn StanLakesideClient_fnc_refinePelts",4]
	],

	[
		["((player distance (getMarkerPos ""fishRefinery"")) < 70) || typeof (vehicle player) IN [""vvv_NewYacht"",""POP_Speed_yatch""] "],
		["Przetwórz ryby", "closedialog 0; [] spawn StanLakesideClient_fnc_refineFish",4]
	],

	[
		["client_tran == 1 && ((player distance (getMarkerPos ""fishRefinery"")) < 70)"],
		["Tran", "closedialog 0; [] spawn StanLakesideClient_fnc_refineFishOil",4]
	],

	[
		["((player distance (getMarkerPos ""logRefinery"")) < 30)"],
		["Przetwórz drewno", "closedialog 0; [] spawn StanLakesideClient_fnc_refineLogs",4]
	],

	[
		["((player distance (getMarkerPos ""oilRefinery"")) < 30)"],
		["Przetwórz ropę", "closedialog 0; [] spawn StanLakesideClient_fnc_refineoil;",4]
	],

	[
		["((player distance (getMarkerPos ""OreRefinery"")) < 30)"],
		["Przetwórz rudę", "closedialog 0; [] spawn StanLakesideClient_fnc_refinemetal1;",4]
	],

	[
		["ClientArrested && player distance [5616.14,6313.37,0.00143433] < 8"],
		["Wytwórz narzędzie hakujące", "[""Wytwarzam narzędzie hakujące"",20,StanLakesideClient_fnc_crafthackingdevice,player,'AinvPknlMstpSnonWnonDnon_medic_1',player,0] spawn StanLakesideClient_fnc_dotask; ",4]
	],
	...
	[
		...
		["Wytwórz wytrych", "[""Wytwarzam wytrych"",60,StanLakesideClient_fnc_craftlockpick,player,'AmovPercMstpSnonWnonDnon_exercisePushup',player,0] spawn StanLakesideClient_fnc_dotask; ",4]
	],
	...
	[
		...
		["Sprzedaj ryby", "closedialog 0; [] spawn StanLakesideClient_fnc_sellFish",4]
	],

	[
		["str CurrentCursorTarget find ""plp_cts_contshippinggreen"" > -1 && getpos player distance getpos currentcursortarget < 4"],
		["Przeszukaj obiekt", "[""Szukam"",7,StanLakesideClient_fnc_searchcrates,player,'AinvPknlMstpSnonWnonDnon_medic_1',player,""cg_sndimg\sounds\repair.ogg""] spawn StanLakesideClient_fnc_dotask; ",4]
	],

	[
		["myjob != ""none"" && (typeof CurrentCursorTarget IN [""Land_Centrelink""] || player distance myhouse < 20)"],
		["Zakończ pracę", "[] spawn StanLakesideClient_fnc_jobEnd;",4]
	],

	[
		["myjob != ""none"" && typeof CurrentCursorTarget IN [""Land_Centrelink""]"],
		["Pojazd służbowy", "[] spawn StanLakesideClient_fnc_spawnjobvehicle",4]
	],

	[
		["typeof CurrentCursorTarget == ""Land_Centrelink"""],
		["Szukaj pracy", "[player] spawn StanLakesideClient_fnc_startjob",4]
	],

	[
		["myjob == ""Repairman"""],
		["Napraw obiekt", "[""Naprawiam obiekt"",15,StanLakesideClient_fnc_repairNear,player,'AinvPknlMstpSnonWnonDnon_medic_1',player,""cg_sndimg\sounds\repair.ogg""] spawn StanLakesideClient_fnc_dotask; ",4]
	],

	[
		["adminInteractions>=1"],
		["Napraw obiekt", "[""Naprawiam obiekt"",1,StanLakesideClient_fnc_repairNear,player,'AinvPknlMstpSnonWnonDnon_medic_1',player,""cg_sndimg\sounds\repair.ogg""] spawn StanLakesideClient_fnc_dotask; ",4]
	],
