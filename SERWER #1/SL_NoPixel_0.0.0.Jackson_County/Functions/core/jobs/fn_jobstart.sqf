...
[player,objNull,3,format ["%1 rozpoczął pracę %2", name player, _jobtype],_jobtype] remoteExec ["StanLakesideServer_fnc_jobLog", 2];
if (str _jobtype find "Cop" > -1 || str _jobtype == "Cop") exitwith {
	[_player, getUnitLoadout _player] remoteexec ["StanLakesideServer_fnc_statSave",2];	
	[] spawn StanLakesideClient_fnc_startCop;
	currentCop pushback _player;
	publicvariable "currentCop";
	["basic"] spawn StanLakesideClient_fnc_setGear;
	[player,objNull,10,format ["%1 rozpoczął służbę", name player],""] remoteExec ["StanLakesideServer_fnc_copLog", 2];
};

if (str _jobtype find "EMS" > -1 || str _jobtype == "EMS") exitwith {
	[_player, getUnitLoadout _player] remoteexec ["StanLakesideServer_fnc_statSave",2];		
	[] spawn StanLakesideClient_fnc_startEMS;
...
if (str _jobtype find "Fire" > -1 || str _jobtype == "Fire") exitwith {
	[_player, getUnitLoadout _player] remoteexec ["StanLakesideServer_fnc_statSave",2];		
	[] spawn StanLakesideClient_fnc_startFire;
...
if (str _jobtype find "Police Dispatch" > -1 || str _jobtype == "Police Dispatch") exitwith {   
	[] spawn StanLakesideClient_fnc_startDispatch;
...
if (str _jobtype find "security" > -1 || str _jobtype == "security") exitwith {
	[] spawn StanLakesideClient_fnc_startSecurity;
...
if (str _jobtype find "Prosecutor" > -1  || str _jobtype == "Prosecutor") exitwith {
	[] spawn StanLakesideClient_fnc_startProsecutor;	
...
if (str _jobtype find "Tow Truck Driver" > -1  || str _jobtype == "Tow Truck Driver") exitwith {
	[] spawn StanLakesideClient_fnc_startTowTruck;
...
if (str _jobtype find "trashman" > -1 || str _jobtype == "trashman") exitwith {
	[] spawn StanLakesideClient_fnc_startGarbage;
...
if (str _jobtype find "reporter" > -1 || str _jobtype == "reporter") exitwith {
	[] spawn StanLakesideClient_fnc_startNews;	
...
if (str _jobtype find "repairman" > -1 || str _jobtype == "repairman") exitwith {	
	[] spawn StanLakesideClient_fnc_startRepair;
